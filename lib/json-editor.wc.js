...
const L = document, pt = window, ie = L.documentElement, P = L.createElement.bind(L), re = P("div"), Tt = P("table"), ze = P("tbody"), Gt = P("tr"), { isArray: Et, prototype: se } = Array, { concat: He, filter: It, indexOf: ae, map: ce, push: Ie, slice: le, some: Ut, splice: Ue } = se, Pe = /^#(?:[\w-]|\\.|[^\x00-\xa0])*$/, De = /^\.(?:[\w-]|\\.|[^\x00-\xa0])*$/, Ve = /<.+>/, Ye = /^\w+$/;
function Pt(t, e) {
  const o = Fe(e);
...
function Ge(t, e) {
  if (t) {
    if (k(t)) {
      ...
      return N(e) ? this : st(e) ? this.removeAttr(t) : this.each((o, n) => {
...
a.get = function(t) {
  return N(t) ? le.call(this) : (t = Number(t), this[t < 0 ? t + this.length : t]);
};
a.eq = function(t) {
  return s(this.get(t));
};
...
function Ke(t) {
  return N(t) ? this.get().map((e) => w(e) || Je(e) ? e.textContent : "").join("") : this.each((e, o) => {
    w(o) && (o.textContent = t);
  });
}
a.text = Ke;
...
function yo(t, e) {
  ...
  if (k(t))
    return arguments.length < 2 ? this[0] && Qt(this[0], t) : N(e) ? this : this.each((o, n) => {
      go(n, t, e);
    });
  for (const o in t)
    this.data(o, t[o]);
...
j([!0, !1], (t, e) => {
  j(["Width", "Height"], (o, n) => {
    ...
    a[i] = function(r) {
      if (this[0])
        return tt(this[0]) ? e ? this[0][`inner${n}`] : this[0].document.documentElement[`client${n}`] : U(this[0]) ? ye(this[0], n) : this[0][`${e ? "offset" : "client"}${n}`] + (r && e ? A(this[0], `margin${o ? "Top" : "Left"}`) + A(this[0], `margin${o ? "Bottom" : "Right"}`) : 0);
    };
  });
});
j(["Width", "Height"], (t, e) => {
...
a.toggle = function(t) {
  return this.each((e, o) => {
    if (!w(o))
      return;
    const n = qt(o);
    (N(t) ? n : t) ? (o.style.display = o[te] || "", qt(o) && (o.style.display = qe(o.tagName))) : n || (o[te] = S(o, "display"), o.style.display = "none");
  });
};
a.hide = function() {
...
const ee = "___ce", Ft = ".", Jt = { focus: "focusin", blur: "focusout" }, me = { mouseenter: "mouseover", mouseleave: "mouseout" }, mo = /^(mouse|pointer|contextmenu|drag|drop|click|dblclick)/i;
function Zt(t) {
  return me[t] || Jt[t] || t;
}
function Wt(t) {
...
a.trigger = function(t, e) {
  if (k(t)) {
    ...
    t = L.createEvent(l), t.initEvent(r, !0, !0), t.namespace = i.join(Ft), t.___ot = n;
  }
  t.___td = e;
  const o = t.___ot in Jt;
...
function vo(t, e, o, n, i) {
  ...
  return k(e) || (N(e) || st(e) ? e = "" : N(o) ? (o = e, e = "") : (n = o, o = e, e = "")), D(n) || (n = o, o = void 0), n ? (j(Rt(t), (r, l) => {
    const [c, f] = Wt(l), u = Zt(c), p = c in me, C = c in Jt;
    u && this.each((v, y) => {
      if (!w(y) && !U(y) && !tt(y))
        return;
      const O = function(m) {
        ...
        if (m.namespace && !ve(f, m.namespace.split(Ft)) || !e && (C && (m.target !== y || m.___ot === u) || p && m.relatedTarget && y.contains(m.relatedTarget)))
          return;
        let V = y;
        if (e) {
          let Y = m.target;
...
class To {
  constructor(e, o, n = !1) {
    ...
    B(this, Z, e), this.el.node = s(o), B(this, W, String(this.el.node.data("type"))), this.el.type = this.el.node.find("& > .node__body > .type"), this.el.type.addClass("open"), this.el.dialog = h(this, yt, ke).call(this, So, b(this, W), n), this.el.dialog.on("click", (i) => i.stopPropagation()), this.el.dialog.find("button").on("click", (i) => h(this, mt, _e).call(this, i)), b(this, Z).customContext(this.el.dialog.get(0), {
      ...
      type: b(this, W),
      isRoot: n
    }, s), this.el.type.append(this.el.dialog), s("body").on(J.CLICK, (i) => this.close(i)), s(window).on(J.KEYUP, (i) => h(this, xt, Ne).call(this, i));
  }
  close() {
    this.el.type.removeClass("open"), this.el.dialog.remove(), s("body").off(J.CLICK), s(window).off(J.KEYUP), delete b(this, Z).context;
  }
}
Z = new WeakMap(), W = new WeakMap(), yt = new WeakSet(), ke = function(e, o, n = !1) {
  function i(c, f) {
    ...
    return u += `<li${y}>`, u += `<button type="button"${m}>`, u += O, u += `<em class="label">${C}</em>`, (p === "change-type" || p === "insert") && (u += `<span class="arrow">${Ao}</span>`), u += "</button>", (v == null ? void 0 : v.length) > 0 && (u += '<div class="children">', u += r(v, p), u += "</div>"), u += "</li>", u;
  }
...
}, xt = new WeakSet(), Ne = function(e) {
  e.code === "Escape" && this.close();
};
var g, G, vt, Ee, at, Mt, K, dt, wt, Ae, jt, Re, q, ut, z, nt, ct, zt, _, E, lt, Ht, H, it, I, rt, X, ht, Q, ft, Ct, Le, kt, Se, _t, Te;
class Oo {
  constructor(e, o = {}) {
    x(this, vt);
    x(this, at);
    ...
    x(this, g, void 0);
    x(this, G, !1);
    this.$ = s, this.el.wrap = s(e), this.el.body = s('<div class="json-editor"></div>'), this.options = new Proxy(Object.assign({}, No, o), {
      get: (n, i) => n[i],
      set: h(this, vt, Ee).bind(this)
  ...
  addNode(e, o, n = !0, i = !0) {
    ...
    l === "before" ? y.prepend(v) : y.append(v), i && h(this, H, it).call(this, e), (C === d.ARRAY || C === d.OBJECT) && f && typeof f == "function" && f(v.get(0), p), n && h(this, _, E).call(this);
  }
  /**
   * remove node
  ...
  removeNode(e, o = !0) {
    ...
    e.remove(), h(this, H, it).call(this, n), o && h(this, _, E).call(this);
  }
  /**
   * change type
   * @param {HTMLElement} node
  ...
  changeType(e, o, n = !0) {
    ...
    i.empty(), i.html(h(this, K, dt).call(this, o, c).html()), l && i.find("& > .node__children > .tree").html(l), h(this, q, ut).call(this, i, r), h(this, I, rt).call(this, i), i.attr("data-type", o), n && h(this, _, E).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, o = !0) {
    ...
    h(this, I, rt).call(this, n), e.after(n), h(this, H, it).call(this, e.parent().closest(".node")), o && h(this, _, E).call(this);
  }
  /**
   * fold node
   * @param {HTMLElement} $node
  ...
  clear() {
    this.el.tree && (this.el.body.empty(), this.replace({}, !1), h(this, _, E).call(this));
  }
  destroy() {
    s(window).off(F.END).off(J.CLICK).off(J.KEYUP), this.el.wrap.empty();
  }
  /**
   * replace
  ...
  replace(e, o = !0) {
    ...
    const n = h(this, wt, Ae).call(this, e);
    this.import(n, e, !1, !1), o && h(this, _, E).call(this);
  }
  /**
   * import data
   * @param {HTMLElement} $target
  ...
  import(e, o, n = !0, i = !0) {
    ...
    }), i && h(this, H, it).call(this, e), n && h(this, _, E).call(this);
  }
  /**
   * export
   * @param {HTMLElement} $node
...
g = new WeakMap(), G = new WeakMap(), vt = new WeakSet(), Ee = function(e, o, n) {
  switch (e[o] = n, o) {
    case "theme":
  ...
  return n += '<div class="node__body">', o || (n += `<div class="sort">${Lo}</div>`), n += '<div class="type"><button type="button"></button></div>', (e === d.OBJECT || e === d.ARRAY) && (n += `<button type="button" class="fold">${Ro}</button>`), o || (n += '<div class="key"></div>'), n += '<em class="count"></em>', o || (n += '<div class="value"></div>'), n += "</div>", n += '<div class="node__children"><ul class="tree"/></div>', n += "</li>", s(n);
...
}, jt = new WeakSet(), Re = function(e, o, n) {
  switch (o) {
    case "change-type":
      this.changeType(e, n);
      break;
  ...
  const o = e.find(".sort");
  o.length && o.on(F.START, h(this, Ct, Le).bind(this)), e.find(".type > button").on("click", async (c) => {
    ...
    if (c.stopPropagation(), f.parent().hasClass("open"))
      ...
      this.context = new To(this, f.closest(".node"), u), this.context.selectItem = (p, C, v) => h(this, jt, Re).call(this, p, C, v);
    }
  ...
  l.length && l.on("click", (c) => {
    ...
    f.data("value", u).find("i").text(u.toString().toUpperCase()), h(this, _, E).call(this);
  });
}, X = new WeakSet(), ht = function() {
  B(this, G, !0);
}, Q = new WeakSet(), ft = function() {
  b(this, G) && (h(this, _, E).call(this), B(this, G, !1));
  ...
  b(this, g).$nodes.on(F.MOVE, h(this, kt, Se).bind(this)), s(window).on(F.END, h(this, _t, Te).bind(this));
}, kt = new WeakSet(), Se = function(e) {
  let o;
  if (e.pointerType === "touch") {
    const { clientX: c, clientY: f } = e, u = document.elementFromPoint(c, f).closest(".node");
    if (!b(this, g).$nodes.get().includes(u))
      return;
    o = s(u);
  } else
    o = s(e.currentTarget);
...
class Mo extends HTMLElement {
  ...
  connectedCallback() {
    this.core = new Oo(this.root, this.options), this.core.replace(this.data, !0), this.core.preview = (o) => {
      this.data = o, h(this, Nt, Oe).call(this, "update", { data: o });
    };
  }
  /**
   * unmounted component
...
Nt = new WeakSet(), Oe = function(o, n) {
