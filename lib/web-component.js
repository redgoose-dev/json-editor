...
var Me = (t, e, n) => e in t ? Be(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var Lt = (t, e, n) => (Me(t, typeof e != "symbol" ? e + "" : e, n), n), Tt = (t, e, n) => {
  if (!e.has(t))
    throw TypeError("Cannot " + n);
};
var d = (t, e, n) => (Tt(t, e, "read from private field"), n ? n.call(t) : e.get(t)), m = (t, e, n) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, n);
}, M = (t, e, n, o) => (Tt(t, e, "write to private field"), o ? o.call(t, n) : e.set(t, n), n);
var f = (t, e, n) => (Tt(t, e, "access private method"), n);
const S = document, ft = window, ie = S.documentElement, P = S.createElement.bind(S), re = P("div"), St = P("table"), ze = P("tbody"), Gt = P("tr"), { isArray: Et, prototype: se } = Array, { concat: He, filter: It, indexOf: ae, map: ce, push: Ie, slice: le, some: Ut, splice: Ue } = se, Pe = /^#(?:[\w-]|\\.|[^\x00-\xa0])*$/, De = /^\.(?:[\w-]|\\.|[^\x00-\xa0])*$/, Ve = /<.+>/, Ye = /^\w+$/;
function Pt(t, e) {
  const n = Je(e);
  return !t || !n && !U(e) && !C(e) ? [] : !n && De.test(t) ? e.getElementsByClassName(t.slice(1).replace(/\\/g, "")) : !n && Ye.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
}
class Nt {
  constructor(e, n) {
    if (!e)
    ...
    if (E(e)) {
      const i = n || S;
      if (o = Pe.test(e) && U(i) ? i.getElementById(e.slice(1).replace(/\\/g, "")) : Ve.test(e) ? he(e) : Bt(i) ? i.find(e) : E(i) ? a(i).find(e) : Pt(e, i), !o)
        return;
    } else if (D(e))
      return this.ready(e);
...
function pt(...t) {
  ...
  for (let i = 0; i < o; i++) {
    const r = t[i];
    for (const l in r)
      e && (Et(r[l]) || Dt(r[l])) ? ((!n[l] || n[l].constructor !== r[l].constructor) && (n[l] = new r[l].constructor()), pt(e, n[l], r[l])) : n[l] = r[l];
  }
  return n;
}
a.extend = pt;
...
function Ge(t, e) {
  if (t) {
    if (E(t)) {
      ...
      return R(e) ? this : it(e) ? this.removeAttr(t) : this.each((n, o) => {
        C(o) && o.setAttribute(t, e);
      });
    }
    for (const n in t)
      this.attr(n, t[n]);
...
s.get = function(t) {
  return R(t) ? le.call(this) : (t = Number(t), this[t < 0 ? t + this.length : t]);
};
s.eq = function(t) {
  return a(this.get(t));
};
...
function Ke(t) {
  return R(t) ? this.get().map((e) => C(e) || Fe(e) ? e.textContent : "").join("") : this.each((e, n) => {
    C(n) && (n.textContent = t);
  });
}
s.text = Ke;
...
function qe(t) {
  ...
  const n = O(e, "display");
  return S.body.removeChild(e), Ot[t] = n !== "none" ? n : "block";
}
function qt(t) {
...
function At(t) {
  return E(t) ? (e, n) => ue(n, t) : D(t) ? t : Bt(t) ? (e, n) => t.is(n) : t ? (e, n) => n === t : () => !1;
}
s.filter = function(t) {
  const e = At(t);
  return a(It.call(this, (n, o) => e.call(n, o, n)));
};
function z(t, e) {
...
function he(t) {
  ...
  if (Qe.test(t))
    return [P(RegExp.$1)];
  const e = Xe.test(t) && RegExp.$1, n = Xt[e] || Xt["*"];
  return n.innerHTML = t, a(n.childNodes).detach().get();
}
a.parseHTML = he;
s.has = function(t) {
  const e = E(t) ? (n, o) => Pt(t, o).length : (n, o) => o.contains(t);
  return this.filter(e);
};
s.not = function(t) {
  const e = At(t);
  return this.filter((n, o) => (!E(t) || C(o)) && !e.call(o, n, o));
};
function $(t, e, n, o) {
  const i = [], r = D(e), l = o && At(o);
  for (let c = 0, b = t.length; c < b; c++)
    if (r) {
      const h = e(t[c]);
      h.length && Ie.apply(i, h);
    } else {
      let h = t[c][e];
      for (; h != null && !(o && l(-1, h)); )
...
s.is = function(t) {
  const e = At(t);
  return Ut.call(this, (n, o) => e.call(n, o, n));
};
a.guid = 1;
function T(t) {
  return t.length > 1 ? It.call(t, (e, n, o) => ae.call(o, e) === n) : t;
}
a.unique = T;
s.add = function(t, e) {
...
s.children = function(t) {
  return z(a(T($(this, (e) => e.children))), t);
};
s.parent = function(t) {
  return z(a(T($(this, "parentNode"))), t);
};
s.index = function(t) {
...
s.siblings = function(t) {
  return z(a(T($(this, (e) => a(e).parent().children().not(e)))), t);
};
s.find = function(t) {
  return a(T($(this, (e) => Pt(t, e))));
};
const en = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, nn = /^$|^module$|\/(java|ecma)script/i, on = ["type", "src", "nonce", "noModule"];
function rn(t, e) {
  const n = a(t);
  n.filter("script").add(n.find("script")).each((o, i) => {
    if (nn.test(i.type) && ie.contains(i)) {
      const r = P("script");
      r.text = i.textContent.replace(en, ""), k(on, (l, c) => {
        i[c] && (r[c] = i[c]);
...
function sn(t, e, n, o, i) {
  o ? t.insertBefore(e, n ? t.firstChild : null) : t.nodeName === "HTML" ? t.parentNode.replaceChild(e, t) : t.parentNode.insertBefore(e, n ? t : t.nextSibling), i && rn(e, t.ownerDocument);
}
function H(t, e, n, o, i, r, l, c) {
  return k(t, (b, h) => {
    k(a(h), (p, w) => {
      k(a(e), (_, x) => {
        const B = n ? w : x, y = n ? x : w, V = n ? p : _;
        sn(B, V ? y.cloneNode(!0) : y, o, i, !V);
      }, c);
    }, l);
  }, r), e;
}
...
function an(t) {
  ...
  return this.each((n, o) => {
    C(o) && (e ? a(o).empty().append(t) : o.innerHTML = t);
  });
}
s.html = an;
...
s.contents = function() {
  return a(T($(this, (t) => t.tagName === "IFRAME" ? [t.contentDocument] : t.tagName === "TEMPLATE" ? t.content.childNodes : t.childNodes)));
};
s.next = function(t, e, n) {
  return z(a(T($(this, "nextElementSibling", e, n))), t);
};
...
s.parents = function(t, e) {
  return z(a(T($(this, "parentElement", !0, e))), t);
};
s.parentsUntil = function(t, e) {
  return this.parents(e, t);
};
s.prev = function(t, e, n) {
  return z(a(T($(this, "previousElementSibling", e, n))), t);
};
...
s.map = function(t) {
  return a(He.apply([], ce.call(this, (e, n) => t.call(e, n, e))));
};
s.clone = function() {
...
s.prop = function(t, e) {
  if (t) {
    if (E(t))
      return t = pe[t] || t, arguments.length < 2 ? this[0] && this[0][t] : this.each((n, o) => {
        o[t] = e;
      });
    for (const n in t)
      this.prop(n, t[n]);
...
const $t = {}, { style: dn } = re, un = ["webkit", "moz", "ms"];
function hn(t, e = Yt(t)) {
  if (e)
    return t;
  if (!$t[t]) {
    const n = Vt(t), o = `${n[0].toUpperCase()}${n.slice(1)}`, i = `${n} ${un.join(`${o} `)}${o}`.split(" ");
    k(i, (r, l) => {
      if (l in dn)
        return $t[t] = l, !1;
    });
...
function be(t, e, n = Yt(t)) {
  return !n && !fn[t] && de(e) ? `${e}px` : e;
}
function pn(t, e) {
  if (E(t)) {
    const n = Yt(t);
    return t = hn(t, n), arguments.length < 2 ? this[0] && O(this[0], t, n) : t ? (e = be(t, e, n), this.each((o, i) => {
...
function Qt(t, e) {
  ...
  return bn.test(n) ? n : ge(JSON.parse, n);
}
function gn(t, e, n) {
...
function yn(t, e) {
  ...
  if (E(t))
    return arguments.length < 2 ? this[0] && Qt(this[0], t) : R(e) ? this : this.each((n, o) => {
      gn(o, t, e);
    });
  for (const n in t)
    this.data(n, t[n]);
...
k([!0, !1], (t, e) => {
  k(["Width", "Height"], (n, o) => {
    ...
    s[i] = function(r) {
      if (this[0])
        return et(this[0]) ? e ? this[0][`inner${o}`] : this[0].document.documentElement[`client${o}`] : U(this[0]) ? ye(this[0], o) : this[0][`${e ? "offset" : "client"}${o}`] + (r && e ? L(this[0], `margin${n ? "Top" : "Left"}`) + L(this[0], `margin${n ? "Bottom" : "Right"}`) : 0);
    };
  });
});
k(["Width", "Height"], (t, e) => {
  ...
  s[n] = function(o) {
    ...
    return this.each((r, l) => {
      if (!C(l))
        return;
      const c = O(l, "boxSizing");
      l.style[n] = be(n, i + (c === "border-box" ? Kt(l, !t) : 0));
    });
  };
});
const te = "___cd";
s.toggle = function(t) {
  return this.each((e, n) => {
    if (!C(n))
      return;
    const o = qt(n);
    (R(t) ? o : t) ? (n.style.display = n[te] || "", qt(n) && (n.style.display = qe(n.tagName))) : o || (n[te] = O(n, "display"), n.style.display = "none");
  });
};
s.hide = function() {
...
const ee = "___ce", Jt = ".", Ft = { focus: "focusin", blur: "focusout" }, me = { mouseenter: "mouseover", mouseleave: "mouseout" }, mn = /^(mouse|pointer|contextmenu|drag|drop|click|dblclick)/i;
function Zt(t) {
  return me[t] || Ft[t] || t;
}
function Wt(t) {
...
s.trigger = function(t, e) {
  if (E(t)) {
    const [o, i] = Wt(t), r = Zt(o);
    if (!r)
      return this;
    const l = mn.test(r) ? "MouseEvents" : "HTMLEvents";
    t = S.createEvent(l), t.initEvent(r, !0, !0), t.namespace = i.join(Jt), t.___ot = o;
  }
  t.___td = e;
...
function bt(t, e, n, o, i) {
  const r = xe(t);
  if (e)
    r[e] && (r[e] = r[e].filter(([l, c, b]) => {
      if (i && b.guid !== i.guid || !ve(l, n) || o && o !== c)
        return !0;
...
s.off = function(t, e, n) {
  if (R(t))
    ...
    D(e) && (n = e, e = ""), k(Rt(t), (o, i) => {
      const [r, l] = Wt(i), c = Zt(r);
      this.each((b, h) => {
        !C(h) && !U(h) && !et(h) || bt(h, c, l, e, n);
      });
    });
  else
    for (const o in t)
...
function vn(t, e, n, o, i) {
  ...
  return E(e) || (R(e) || it(e) ? e = "" : R(n) ? (n = e, e = "") : (o = n, n = e, e = "")), D(o) || (o = n, n = void 0), o ? (k(Rt(t), (r, l) => {
    const [c, b] = Wt(l), h = Zt(c), p = c in me, w = c in Ft;
    h && this.each((_, x) => {
      if (!C(x) && !U(x) && !et(x))
        return;
      const B = function(y) {
        ...
        if (y.namespace && !ve(b, y.namespace.split(Jt)) || !e && (w && (y.target !== x || y.___ot === h) || p && y.relatedTarget && x.contains(y.relatedTarget)))
          return;
        let V = x;
        if (e) {
          let Y = y.target;
          for (; !ue(Y, e); )
            if (Y === x || (Y = Y.parentNode, !Y))
              return;
          V = Y;
        }
        ...
        const $e = o.call(V, y, y.___td);
        i && bt(x, h, b, e, B), $e === !1 && (y.preventDefault(), y.stopPropagation());
      };
      B.guid = o.guid = o.guid || a.guid++, xn(x, h, b, e, B);
    });
  }), this) : this;
}
s.on = vn;
...
const jn = /\r?\n/g;
function Cn(t, e) {
  return `&${encodeURIComponent(t)}=${encodeURIComponent(e.replace(jn, `\r
`))}`;
}
const kn = /file|reset|submit|button|image/i, we = /radio|checkbox/i;
s.serialize = function() {
  let t = "";
  return this.each((e, n) => {
    k(n.elements || [n], (o, i) => {
      if (i.disabled || !i.name || i.tagName === "FIELDSET" || kn.test(i.type) || we.test(i.type) && !i.checked)
        return;
      const r = fe(i);
      if (!R(r)) {
        const l = Et(r) ? r : [r];
...
class Sn {
  constructor(e, n, o = !1) {
    ...
    m(this, W, void 0);
    M(this, Z, e), d(this, j).node = a(n), M(this, W, String(d(this, j).node.data("type"))), d(this, j).type = d(this, j).node.find("& > .node__body > .type"), d(this, j).type.addClass("open"), d(this, j).dialog = f(this, gt, ke).call(this, Tn, d(this, W), o), d(this, j).dialog.on("click", (i) => i.stopPropagation()), d(this, j).dialog.find("button").on("click", (i) => f(this, yt, _e).call(this, i)), d(this, Z).customContext(d(this, j).dialog.get(0), {
      node: d(this, j).node.get(0),
      type: d(this, W),
      isRoot: o
    }, a), d(this, j).type.append(d(this, j).dialog), a(window).on(F.CLICK, (i) => this.close(i)), a(window).on(F.KEYUP, (i) => f(this, mt, Ee).call(this, i));
  }
  close() {
    d(this, j).type.removeClass("open"), d(this, j).dialog.remove(), a(window).off(F.CLICK), a(window).off(F.KEYUP), delete d(this, Z).context;
  }
}
Z = new WeakMap(), j = new WeakMap(), W = new WeakMap(), gt = new WeakSet(), ke = function(e, n, o = !1) {
  function i(c, b) {
    let h = "";
    const { key: p, label: w, children: _ } = c;
    if (o)
      switch (p) {
        case u.STRING:
        case u.NUMBER:
    ...
    switch (p) {
      ...
      case "insert":
        ...
        break;
      case "duplicate":
        x = ' class="duplicate"', y = ' data-mode="duplicate"';
        break;
      case "remove":
        x = ' class="remove"', y = ' data-mode="remove"';
        break;
      case u.OBJECT:
      case u.ARRAY:
      case u.STRING:
      ...
      case u.BOOLEAN:
      case u.NULL:
        x = ' class="type"', B = `<i class="type-icon type-icon--${p}">${Ce[p]}</i>`, y = ` data-mode="${b}" data-type="${p}"`, b === "change-type" && p === n && (y = " disabled");
        break;
    }
    return h += `<li${x}>`, h += `<button type="button"${y}>`, h += B, h += `<em class="label">${w}</em>`, (p === "change-type" || p === "insert") && (h += `<span class="arrow">${Rn}</span>`), h += "</button>", (_ == null ? void 0 : _.length) > 0 && (h += '<div class="children">', h += r(_, p), h += "</div>"), h += "</li>", h;
  }
  function r(c, b = void 0) {
    let h = "<ol>";
    for (let p in c)
      h += i(c[p], b);
    return h += "</ol>", h;
  }
  let l = `<nav class="context${o ? " is-root" : ""}">`;
  return l += r(e), l += "</nav>", a(l);
}, yt = new WeakSet(), _e = function(e) {
  const n = a(e.currentTarget), o = n.data("mode");
  let i = String(n.data("type"));
  i = i === "undefined" ? "" : i, this.close(), this.selectItem && typeof this.selectItem == "function" && this.selectItem(d(this, j).node, o, i);
}, mt = new WeakSet(), Ee = function(e) {
  e.code === "Escape" && this.close();
};
var v, g, G, xt, Ne, rt, Mt, K, ct, vt, Re, wt, Ae, q, lt, X, dt, st, zt, N, A, at, Ht, I, ot, Q, ut, tt, ht, jt, Le, Ct, Te, kt, Se;
class On {
  constructor(e, n = {}) {
    m(this, xt);
    m(this, rt);
    ...
    m(this, Ct);
    m(this, kt);
    m(this, v, { wrap: null, body: null, tree: null });
    Lt(this, "options");
    Lt(this, "context");
    m(this, g, void 0);
    m(this, G, !1);
    d(this, v).wrap = a(e), d(this, v).body = a('<div class="json-editor"></div>'), this.options = new Proxy(Object.assign({}, En, n), {
      get: (o, i) => o[i],
      set: f(this, xt, Ne).bind(this)
    }), d(this, v).wrap.append(d(this, v).body), f(this, rt, Mt).call(this, this.options.theme), this.replace({}, !1);
  }
  /**
   * PUBLIC METHODS
   */
  ...
  addNode(e, n, o = !0) {
    n = { ...Nn, ...n };
    const { data: i, between: r, open: l, callback: c } = n;
    e = a(e);
    const { key: b, value: h, type: p } = i, w = f(this, K, ct).call(this, p, !1);
    f(this, q, lt).call(this, w, { ...i, open: l }), f(this, I, ot).call(this, w);
    const _ = e.find("& > .node__children > ul");
    r === "before" ? _.prepend(w) : _.append(w), (p === u.ARRAY || p === u.OBJECT) && c && typeof c == "function" && c(w.get(0), h), o && f(this, N, A).call(this);
  }
  /**
   * remove node
   ...
   */
  removeNode(e, n = !0) {
    e = a(e), e.remove(), n && f(this, N, A).call(this);
  }
  /**
   * change type
   * @param {HTMLElement} node
  ...
  changeType(e, n, o = !0) {
    ...
    i.empty(), i.html(f(this, K, ct).call(this, n, c).html()), l && i.find("& > .node__children > .tree").html(l), f(this, q, lt).call(this, i, r), f(this, I, ot).call(this, i), i.attr("data-type", n), o && f(this, N, A).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, n = !0) {
    ...
    f(this, I, ot).call(this, o), e.after(o), n && f(this, N, A).call(this);
  }
  fold(e, n) {
    e = a(e), n === void 0 ? e.toggleClass("open") : n === !0 ? e.addClass("open") : e.removeClass("open");
  }
  clear() {
    d(this, v).tree && (d(this, v).body.empty(), this.replace({}, !1), f(this, N, A).call(this));
  }
  destroy() {
    a(window).off(J.END).off(F.CLICK).off(F.KEYUP), d(this, v).wrap.empty();
  }
  /**
   * replace
   ...
   */
  replace(e, n = !0) {
    d(this, v).body.empty(), e = je(e);
    const o = f(this, vt, Re).call(this, e);
    this.import(o, e, !1), n && f(this, N, A).call(this);
  }
  /**
   * import data
   * @param {HTMLElement} target
  ...
  import(e, n, o = !0) {
    a.each(n, (i, r) => {
      const l = ne(r), c = { key: i, value: r, type: l };
      this.addNode(e, {
        data: c,
        open: !1,
        callback: (b, h) => this.import(b, h, !1)
      }, !1);
    }), o && f(this, N, A).call(this);
  }
  /**
   * export
   * @param {HTMLElement} $node
   ...
   * @return {array|object}
   */
  export(e = void 0, n, o = 2) {
    let i = f(this, at, Ht).call(this, e);
    if (n) {
      let r = 2;
      return o === !0 ? r = "	" : typeof o === u.NUMBER && (r = o), JSON.stringify(i, null, r);
    } else
      return i;
  }
  /**
...
v = new WeakMap(), g = new WeakMap(), G = new WeakMap(), xt = new WeakSet(), Ne = function(e, n, o) {
  switch (e[n] = o, n) {
    case "theme":
  ...
  e = ["system", "light", "dark"].indexOf(e) > -1 ? e : "system", d(this, v).body.attr("data-theme", e);
}, K = new WeakSet(), ct = function(e, n = !1) {
  let o = `<li data-type="${e}" class="node${n ? " root" : ""}">`;
  return o += '<div class="node__body">', n || (o += `<div class="sort">${Ln}</div>`), o += '<div class="type"><button type="button"></button></div>', (e === u.OBJECT || e === u.ARRAY) && (o += `<button type="button" class="fold">${An}</button>`), n || (o += '<div class="key"></div>'), o += '<em class="count"></em>', n || (o += '<div class="value"></div>'), o += "</div>", o += '<div class="node__children"><ul class="tree"/></div>', o += "</li>", a(o);
}, vt = new WeakSet(), Re = function(e) {
  const n = ne(e), o = f(this, K, ct).call(this, n, !0);
  return f(this, q, lt).call(this, o, {
    key: void 0,
    value: e,
    type: n,
    open: !0
  }), f(this, I, ot).call(this, o), d(this, v).tree = a("<ul/>"), d(this, v).tree.append(o), d(this, v).body.append(d(this, v).tree), o;
  ...
  const { key: o, value: i, type: r, open: l } = n, c = e.hasClass("root"), b = e.children(".node__body");
  if (b.find(".type > button").html(`<i class="type-icon type-icon--${r}">${Ce[r]}</i>`), (r === u.OBJECT || r === u.ARRAY) && this.fold(e, l), !c) {
    b.find(".key").html(`<div class="label-field" contenteditable="true" data-placeholder="empty">${o}</div>`);
    const h = b.find(".value");
    let p;
    switch (r) {
      case u.STRING:
        h.html(`<div contenteditable="true" data-placeholder="empty" class="label-field type-string">${String(i)}</div>`);
        break;
      case u.NUMBER:
        p = Number(i), isNaN(p) && (p = 0), h.html(`<input type="number" value="${p}" placeholder="0" class="label-field type-number"/>`);
        break;
      case u.BOOLEAN:
        p = i === "false" ? !1 : !!i, h.html(`<button type="button" data-value="${p}" class="label-switch type-boolean"><span><i>${p.toString().toUpperCase()}</i></span></button>`);
        break;
      case u.NULL:
  ...
  switch (n) {
    ...
    case u.ARRAY:
      return "";
    case u.STRING:
      return o.children(".type-string").get(0).innerText || "";
    case u.NUMBER:
  ...
  const n = (r, l) => {
    ...
    return r.find("& > .node__children > ul > li").each((h, p) => {
      if (!(l === u.ARRAY || l === u.OBJECT))
        return !0;
      p = a(p);
      const w = f(this, X, dt).call(this, p);
      switch (w) {
        case u.OBJECT:
        case u.ARRAY:
          switch (l) {
            case u.ARRAY:
              ...
              break;
            case u.OBJECT:
              const x = p.find("& > .node__body > .key").text();
              x && (c[x] = n(p, w));
              break;
          }
          break;
        ...
        case u.BOOLEAN:
        case u.NULL:
          const _ = f(this, st, zt).call(this, p);
          switch (l) {
            case u.ARRAY:
              c.push(_);
              break;
  ...
  e = a(e);
  const o = (e == null ? void 0 : e.length) > 0 ? e : d(this, v).tree.children(".node"), i = f(this, X, dt).call(this, o);
  return [u.OBJECT, u.ARRAY].includes(i) ? n(o, i) : void 0;
}, I = new WeakSet(), ot = function(e) {
  const n = e.find(".sort");
  n.length && n.on(J.START, f(this, jt, Le).bind(this)), e.find(".type > button").on("click", async (c) => {
    const b = a(c.currentTarget);
    if (c.stopPropagation(), b.parent().hasClass("open"))
      this.context && this.context.close();
    else {
      this.context && this.context.close();
      const h = b.closest(".node").hasClass("root");
      this.context = new Sn(this, b.closest(".node"), h), this.context.selectItem = (p, w, _) => f(this, wt, Ae).call(this, p, w, _);
    }
  }), e.find(".fold").on("click", (c) => {
    const h = a(c.currentTarget).closest(".node");
    this.fold(h);
  });
  const o = e.find(".key > .label-field");
  o.length && o.on("keydown", (c) => {
    if (c.keyCode === 13 || oe(c))
      return c.preventDefault();
  }).on("input", (c) => f(this, Q, ut).call(this, c)).on("blur", (c) => f(this, tt, ht).call(this, c));
...
class Mn extends HTMLElement {
  constructor() {
    ...
    n.innerHTML = '<div id="json-editor"></div>';
    const o = new CSSStyleSheet();
    o.replaceSync($n), this.shadowRoot.appendChild(n.content.cloneNode(!0)), this.shadowRoot.adoptedStyleSheets = [o], this.root = this.shadowRoot.childNodes[0], this.ready = !1, this.data = {}, this.options = {
      live: !1,
      theme: "system"
      // system,light,dark
    };
   ...
   */
  connectedCallback() {
    this.core = new On(this.root, this.options), this.core.replace(this.data, !0), this.core.preview = (n) => {
      this.data = n, f(this, _t, Oe).call(this, "update", { data: n });
    };
  }
  /**
   * unmounted component
...
_t = new WeakSet(), Oe = function(n, o) {
