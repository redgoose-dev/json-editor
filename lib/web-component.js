...
var ke = (t, e, n) => e in t ? Ce(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var xt = (t, e, n) => (ke(t, typeof e != "symbol" ? e + "" : e, n), n), vt = (t, e, n) => {
  if (!e.has(t))
    throw TypeError("Cannot " + n);
};
var u = (t, e, n) => (vt(t, e, "read from private field"), n ? n.call(t) : e.get(t)), y = (t, e, n) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, n);
}, V = (t, e, n, o) => (vt(t, e, "write to private field"), o ? o.call(t, n) : e.set(t, n), n);
var b = (t, e, n) => (vt(t, e, "access private method"), n);
const L = document, nt = window, Wt = L.documentElement, H = L.createElement.bind(L), Jt = H("div"), wt = H("table"), _e = H("tbody"), Bt = H("tr"), { isArray: gt, prototype: qt } = Array, { concat: Ee, filter: $t, indexOf: Yt, map: Gt, push: $e, slice: Kt, some: Nt, splice: Ne } = qt, Se = /^#(?:[\w-]|\\.|[^\x00-\xa0])*$/, Le = /^\.(?:[\w-]|\\.|[^\x00-\xa0])*$/, Te = /<.+>/, Ae = /^\w+$/;
function St(t, e) {
  const n = Re(e);
  return !t || !n && !B(e) && !x(e) ? [] : !n && Le.test(t) ? e.getElementsByClassName(t.slice(1).replace(/\\/g, "")) : !n && Ae.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
}
class bt {
  constructor(e, n) {
    if (!e)
    ...
    if (C(e)) {
      const i = n || L;
      if (o = Se.test(e) && B(i) ? i.getElementById(e.slice(1).replace(/\\/g, "")) : Te.test(e) ? te(e) : kt(i) ? i.find(e) : C(i) ? a(i).find(e) : St(e, i), !o)
        return;
    } else if (D(e))
      return this.ready(e);
...
function ot(...t) {
  ...
  for (let i = 0; i < o; i++) {
    const r = t[i];
    for (const c in r)
      e && (gt(r[c]) || Lt(r[c])) ? ((!n[c] || n[c].constructor !== r[c].constructor) && (n[c] = new r[c].constructor()), ot(e, n[c], r[c])) : n[c] = r[c];
  }
  return n;
}
a.extend = ot;
...
s.hasClass = function(t) {
  return !!t && Nt.call(this, (e) => x(e) && e.classList.contains(t));
};
s.get = function(t) {
...
function He(t) {
  return E(t) ? this.get().map((e) => x(e) || Oe(e) ? e.textContent : "").join("") : this.each((e, n) => {
    x(n) && (n.textContent = t);
  });
}
s.text = He;
...
function De(t) {
  ...
  const n = T(e, "display");
  return L.body.removeChild(e), jt[t] = n !== "none" ? n : "block";
}
function Dt(t) {
...
function mt(t) {
  return C(t) ? (e, n) => Qt(n, t) : D(t) ? t : kt(t) ? (e, n) => t.is(n) : t ? (e, n) => n === t : () => !1;
}
s.filter = function(t) {
  const e = mt(t);
...
s.not = function(t) {
  const e = mt(t);
  return this.filter((n, o) => (!C(t) || x(o)) && !e.call(o, n, o));
};
function A(t, e, n, o) {
...
function Ve(t) {
  return arguments.length ? this.each((e, n) => {
    ...
    if (o || le.test(n.type)) {
      const i = gt(t) ? Gt.call(t, String) : Y(t) ? [] : [String(t)];
      o ? v(n.options, (r, c) => {
...
function We(t, e) {
  ...
  n.filter("script").add(n.find("script")).each((o, i) => {
    if (Fe.test(i.type) && Wt.contains(i)) {
      const r = H("script");
      r.text = i.textContent.replace(Ue, ""), v(Ze, (c, d) => {
        i[d] && (r[d] = i[d]);
...
s.off = function(t, e, n) {
  if (E(t))
    ...
    D(e) && (n = e, e = ""), v(yt(t), (o, i) => {
      const [r, c] = Mt(i), d = zt(r);
      this.each((f, l) => {
        !x(l) && !B(l) && !Z(l) || it(l, d, c, e, n);
      });
    });
  else
    for (const o in t)
...
function cn(t, e, n, o, i) {
  ...
  return C(e) || (E(e) || Y(e) ? e = "" : E(n) ? (n = e, e = "") : (o = n, n = e, e = "")), D(o) || (o = n, n = void 0), o ? (v(yt(t), (r, c) => {
    const [d, f] = Mt(c), l = zt(d), h = d in se, k = d in Ot;
    l && this.each(($, m) => {
      if (!x(m) && !B(m) && !Z(m))
        return;
      const R = function(p) {
        ...
        if (p.namespace && !ce(f, p.namespace.split(Rt)) || !e && (k && (p.target !== m || p.___ot === l) || h && p.relatedTarget && m.contains(p.relatedTarget)))
          return;
        let P = m;
        if (e) {
          let I = p.target;
        ...
        const je = o.call(P, p, p.___td);
        i && it(m, l, f, e, R), je === !1 && (p.preventDefault(), p.stopPropagation());
      };
...
class mn {
  constructor(e, n, o) {
    ...
    y(this, K, void 0);
    V(this, G, e), u(this, j).node = n, V(this, K, String(u(this, j).node.data("type"))), u(this, j).type = u(this, j).node.find("& > .node__body > .type"), u(this, j).type.addClass("open"), u(this, j).dialog = b(this, rt, fe).call(this, yn, u(this, K), o), u(this, j).dialog.on("click", (i) => i.stopPropagation()), u(this, j).dialog.find("button").on("click", (i) => b(this, st, he).call(this, i)), u(this, j).type.append(u(this, j).dialog), a(window).on("click.json-editor-context", (i) => this.close(i)), a(window).on("keyup.json-editor-context", (i) => b(this, at, pe).call(this, i));
  }
  close() {
    u(this, j).type.removeClass("open"), u(this, j).dialog.remove(), a(window).off("click.json-editor-context"), a(window).off("keyup.json-editor-context"), delete u(this, G).context;
  }
}
G = new WeakMap(), j = new WeakMap(), K = new WeakMap(), rt = new WeakSet(), fe = function(e, n, o = !1) {
  function i(d, f) {
    let l = "";
    const { key: h, label: k, children: $ } = d;
    if (o)
      switch (h) {
        case "string":
        case "number":
    ...
    return l += `<li${m}>`, l += `<button type="button"${p}>`, l += R, l += `<em class="label">${k}</em>`, (h === "change-type" || h === "insert") && (l += `<span class="arrow">${pn}</span>`), l += "</button>", ($ == null ? void 0 : $.length) > 0 && (l += '<div class="children">', l += r($, h), l += "</div>"), l += "</li>", l;
  }
  ...
  i = i === "undefined" ? "" : i, this.close(), this.selectItem && typeof this.selectItem == "function" && this.selectItem(u(this, j).node, o, i);
...
var _, g, ct, ge, X, _t, U, tt, lt, be, dt, ye, F, et, ut, me, M, q, ft, xe, ht, ve, pt, we;
class wn {
  constructor(e, n = {}) {
    y(this, ct);
    y(this, X);
    ...
    xt(this, "context");
    y(this, g, void 0);
    u(this, _).wrap = a(e), this.options = new Proxy(Object.assign({}, xn, n), {
      get: (o, i) => o[i],
      set: b(this, ct, ge).bind(this)
    }), b(this, X, _t).call(this, this.options.theme);
  }
  /**
   * PUBLIC METHODS
   */
  ...
  replace(e) {
    this.clear(), e = de(e);
    const n = b(this, lt, be).call(this, e);
    this.import(n, e);
  }
  /**
   * import data
  ...
  addNode(e) {
    e = { ...vn, ...e };
    const { target: n, data: o, between: i, open: r, callback: c } = e, d = a(n), { key: f, value: l, type: h } = o, k = b(this, U, tt).call(this, h, !1);
    b(this, F, et).call(this, k, { ...o, open: r }), b(this, M, q).call(this, k);
    const $ = d.find("& > .node__children > ul");
    i === "before" ? $.prepend(k) : $.append(k), (h === "array" || h === "object") && c && typeof c == "function" && c(k.get(0), l);
  }
  changeType(e, n) {
    const o = a(e), i = {
      key: o.find("& > .node__body .key").text(),
      value: b(this, ut, me).call(this, o),
      type: n,
      open: o.hasClass("open")
    }, r = o.find("& > .node__children > .tree").html();
    o.empty(), o.html(b(this, U, tt).call(this, n, !1).html()), r && o.find("& > .node__children > .tree").html(r), b(this, F, et).call(this, o, i), b(this, M, q).call(this, o), o.attr("data-type", n);
  }
  duplicate(e) {
    e = a(e);
    const n = a(e.get(0).outerHTML);
    b(this, M, q).call(this, n), e.after(n);
  }
  removeNode(e) {
    e.remove();
  }
  ...
  clear() {
    u(this, _).tree && u(this, _).wrap.empty();
  }
  update() {
  }
  destroy() {
...
_ = new WeakMap(), g = new WeakMap(), ct = new WeakSet(), ge = function(e, n, o) {
  switch (e[n] = o, n) {
    case "theme":
      b(this, X, _t).call(this, o);
      break;
  }
  return !0;
}, X = new WeakSet(), _t = function(e) {
  ...
  return o += '<div class="node__body">', n || (o += `<div class="sort">${bn}</div>`), o += '<div class="type"><button type="button"></button></div>', (e === w.OBJECT || e === w.ARRAY) && (o += `<button type="button" class="fold">${gn}</button>`), n || (o += '<div class="key"></div>'), o += '<em class="count"></em>', n || (o += '<div class="value"></div>'), o += "</div>", o += '<div class="node__children"><ul class="tree"/></div>', o += "</li>", a(o);
}, lt = new WeakSet(), be = function(e) {
  const n = Ft(e), o = b(this, U, tt).call(this, n, !0);
  return b(this, F, et).call(this, o, {
    key: void 0,
    value: e,
    type: n,
    open: !0
  }), b(this, M, q).call(this, o), u(this, _).tree = a("<ul/>"), u(this, _).tree.append(o), u(this, _).wrap.append(u(this, _).tree), o;
  ...
  o.length && o.on(W.START, b(this, ft, xe).bind(this)), e.find(".type > button").on("click", async (d) => {
    const f = a(d.currentTarget);
    d.stopPropagation(), f.parent().hasClass("open") ? this.context && this.context.close() : (this.context && this.context.close(), this.context = new mn(this, f.closest(".node"), n), this.context.selectItem = (l, h, k) => b(this, dt, ye).call(this, l, h, k));
...
}, ft = new WeakSet(), xe = function(e) {
  if (V(this, g, {}), u(this, g).$node = a(e.currentTarget).closest(".node"), u(this, g).$area = u(this, g).$node.parent(), u(this, g).$nodes = u(this, g).$area.children(".node"), u(this, g).$nodes.length < 2) {
    V(this, g, void 0);
    return;
  }
  u(this, g).$nodes.on(W.MOVE, b(this, ht, ve).bind(this)), a(window).on(W.END, b(this, pt, we).bind(this));
}, ht = new WeakSet(), ve = function(e) {
...
class kn extends HTMLElement {
  constructor() {
    ...
    o.replaceSync(jn), this.shadowRoot.appendChild(n.content.cloneNode(!0)), this.shadowRoot.adoptedStyleSheets = [o], this.root = this.shadowRoot.childNodes[0], this.ready = !1, this.data = {}, this.options = {
      live: !1,
      theme: "system"
      // system,light,dark
    };
   ...
   */
  connectedCallback() {
    this.root.addEventListener("json-editor", b(this, Q, Et)), this.core = new wn(this.root, this.options), this.core.replace(this.data);
  }
  /**
   * unmounted component
   */
  disconnectedCallback() {
    console.warn("disconnectedCallback()"), this.root.removeEventListener("json-editor", b(this, Q, Et)), this.core && (this.core.destroy(), delete this.core, this.root.innerHTML = "");
  }
  adoptedCallback() {
