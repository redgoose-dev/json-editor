...
x = new WeakMap(), g = new WeakMap(), G = new WeakMap(), vt = new WeakSet(), Ne = function(e, o, n) {
  ...
  switch (o) {
    ...
    case h.ARRAY:
      return "";
    case h.STRING:
      return n.children(".type-string").text() || "";
    case h.NUMBER:
