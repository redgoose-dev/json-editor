...
class Lt {
  constructor(e, n) {
    ...
    if (N(e)) {
      const s = n || O;
      if (i = He.test(e) && U(s) ? s.getElementById(e.slice(1).replace(/\\/g, "")) : Ue.test(e) ? fe(e) : $t(s) ? s.find(e) : N(s) ? o(s).find(e) : Ut(e, s), !i)
        return;
    } else if (V(e))
      return this.ready(e);
...
c.get = function(t) {
  return k(t) ? ae.call(this) : (t = Number(t), this[t < 0 ? t + this.length : t]);
};
c.eq = function(t) {
  return o(this.get(t));
};
...
function We(t) {
  return k(t) ? this.get().map((e) => w(e) || Ye(e) ? e.textContent : "").join("") : this.each((e, n) => {
    w(n) && (n.textContent = t);
  });
}
c.text = We;
...
function xt(t) {
  return N(t) ? (e, n) => le(n, t) : V(t) ? t : $t(t) ? (e, n) => t.is(n) : t ? (e, n) => n === t : () => !1;
}
c.filter = function(t) {
  const e = xt(t);
...
o.parseHTML = fe;
c.has = function(t) {
  const e = N(t) ? (n, i) => Ut(t, i).length : (n, i) => i.contains(t);
...
function pn(t, e) {
  ...
  if (N(t))
    return arguments.length < 2 ? this[0] && Xt(this[0], t) : k(e) ? this : this.each((n, i) => {
      dn(i, t, e);
    });
  for (const n in t)
    this.data(n, t[n]);
...
c.toggle = function(t) {
  return this.each((e, n) => {
    if (!w(n))
      return;
    const i = qt(n);
    (k(t) ? i : t) ? (n.style.display = n[Qt] || "", qt(n) && (n.style.display = Ge(n.tagName))) : i || (n[Qt] = S(n, "display"), n.style.display = "none");
  });
};
c.hide = function() {
...
function mn(t, e, n, i, s) {
  ...
  return N(e) || (k(e) || ot(e) ? e = "" : k(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (v(Tt(t), (r, u) => {
    const [a, d] = Wt(u), l = Zt(a), p = a in me, R = a in Ft;
    l && this.each((A, b) => {
      if (!w(b) && !U(b) && !et(b))
        return;
      const B = function(m) {
        ...
        if (m.namespace && !Ce(d, m.namespace.split(Jt)) || !e && (R && (m.target !== b || m.___ot === l) || p && m.relatedTarget && b.contains(m.relatedTarget)))
          return;
        let Y = b;
        if (e) {
          let J = m.target;
...
class Tn {
  constructor(e, n, i = !1) {
    ...
    C(this, K, void 0);
    $(this, G, e), this.el.node = o(n), $(this, K, String(this.el.node.data("type"))), this.el.type = this.el.node.find("& > .node__body > .type"), this.el.type.addClass("open"), this.el.dialog = h(this, mt, Ne).call(this, Ln, g(this, K), i), this.el.dialog.on("click", (s) => s.stopPropagation()), this.el.dialog.find("button").on("click", (s) => h(this, bt, Ee).call(this, s)), g(this, G).customContext(this.el.dialog.get(0), {
      node: this.el.node.get(0),
      type: g(this, K),
      isRoot: i
    }, o), this.el.type.append(this.el.dialog), o("body").on(W.CLICK, (s) => this.close(s)), o(window).on(W.KEYUP, (s) => h(this, Ct, ke).call(this, s));
  }
  close() {
    this.el.type.removeClass("open"), this.el.dialog.remove(), o("body").off(W.CLICK), o(window).off(W.KEYUP), delete g(this, G).context;
  }
}
G = new WeakMap(), K = new WeakMap(), mt = new WeakSet(), Ne = function(e, n, i = !1) {
  function s(a, d) {
    let l = "";
    const { key: p, label: R, children: A } = a;
    if (i)
      switch (p) {
        case f.STRING:
        case f.NUMBER:
    ...
    return l += `<li${b}>`, l += `<button type="button"${m}>`, l += B, l += `<em class="label">${R}</em>`, (p === "change-type" || p === "insert") && (l += `<span class="arrow">${kn}</span>`), l += "</button>", (A == null ? void 0 : A.length) > 0 && (l += '<div class="children">', l += r(A, p), l += "</div>"), l += "</li>", l;
  }
...
var y, q, wt, Re, ct, Mt, z, lt, vt, Ae, Nt, Le, X, ft, D, it, at, Pt, E, L, ut, Dt, H, st, I, rt, Q, ht, tt, dt, Et, Te, kt, xe, Rt, Oe;
class _n {
  constructor(e, n = {}) {
    C(this, wt);
    C(this, ct);
  ...
  addNode(e, n, i = {}, s = !0, r = !0) {
    ...
    h(this, X, ft).call(this, l, { ...n, open: u, type: d }), h(this, I, rt).call(this, l), e.find("& > .node__children > ul").append(l), r && h(this, H, st).call(this, e), (d === f.ARRAY || d === f.OBJECT) && a && typeof a == "function" && a(l.get(0), n.value), s && h(this, E, L).call(this);
  }
  /**
   * remove node
  ...
  removeNode(e, n = !0) {
    ...
    e.remove(), h(this, H, st).call(this, i), n && h(this, E, L).call(this);
  }
  /**
   * change type
   * @param {HTMLElement} node
  ...
  changeType(e, n, i = !0) {
    ...
    s.empty(), s.html(h(this, z, lt).call(this, n, a).html()), u && s.find("& > .node__children > .tree").html(u), h(this, X, ft).call(this, s, r), h(this, I, rt).call(this, s), s.attr("data-type", n), i && h(this, E, L).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, n = !0) {
    ...
    h(this, I, rt).call(this, i), e.after(i), h(this, H, st).call(this, e.parent().closest(".node")), n && h(this, E, L).call(this);
  }
  /**
   * fold node
   * @param {HTMLElement} $node
  ...
  import(e, n, i = !0, s = !0) {
    ...
    }), s && h(this, H, st).call(this, e), i && h(this, E, L).call(this);
  }
  /**
   * export
   * @param {HTMLElement} $node
...
y = new WeakMap(), q = new WeakMap(), wt = new WeakSet(), Re = function(e, n, i) {
  ...
  const n = (r, u) => {
    ...
    return r.find("& > .node__children > ul > li").each((l, p) => {
      if (!(u === f.ARRAY || u === f.OBJECT))
        return !0;
      p = o(p);
      const R = h(this, D, it).call(this, p);
      switch (R) {
        case f.OBJECT:
        case f.ARRAY:
          switch (u) {
  ...
  n.length && n.on(Z.START, h(this, Et, Te).bind(this)), e.find(".type > button").on("click", async (a) => {
    ...
    if (a.stopPropagation(), d.parent().hasClass("open"))
      ...
      this.context = new Tn(this, d.closest(".node"), l), this.context.selectItem = (p, R, A) => h(this, Nt, Le).call(this, p, R, A);
    }
