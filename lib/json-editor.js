...
var xt = (t, e, n) => (_e(t, typeof e != "symbol" ? e + "" : e, n), n), Ot = (t, e, n) => {
  if (!e.has(t))
...
function We(t) {
  return T(t) ? this.get().map((e) => E(e) || Ye(e) ? e.textContent : "").join("") : this.each((e, n) => {
    E(n) && (n.textContent = t);
  });
}
o.text = We;
...
o.toggle = function(t) {
  return this.each((e, n) => {
    if (!E(n))
      return;
    const i = qt(n);
    (T(t) ? i : t) ? (n.style.display = n[Qt] || "", qt(n) && (n.style.display = Ge(n.tagName))) : i || (n[Qt] = _(n, "display"), n.style.display = "none");
  });
};
o.hide = function() {
...
function mn(t, e, n, i, s) {
  ...
  return R(e) || (T(e) || st(e) ? e = "" : T(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (L(At(t), (r, a) => {
...
var w, y, K, Ct, Le, rt, Mt, q, at, wt, Re, vt, Ae, z, ut, X, lt, ot, Pt, A, x, ct, Dt, I, it, Q, ft, tt, ht, Nt, Te, Et, xe, kt, Oe;
class Sn {
  constructor(e, n = {}) {
    b(this, Ct);
    b(this, rt);
  ...
  addNode(e, n, i = !0) {
    ...
    r === "before" ? v.prepend(k) : v.append(k), (g === h.ARRAY || g === h.OBJECT) && u && typeof u == "function" && u(k.get(0), l), i && d(this, A, x).call(this);
  }
  /**
   * remove node
  ...
  changeType(e, n, i = !0) {
    ...
    s.empty(), s.html(d(this, q, at).call(this, n, u).html()), a && s.find("& > .node__children > .tree").html(a), d(this, z, ut).call(this, s, r), d(this, I, it).call(this, s), s.attr("data-type", n), i && d(this, A, x).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  clear() {
    f(this, w).tree && (f(this, w).body.empty(), this.replace({}, !1), d(this, A, x).call(this));
  }
  destroy() {
...
w = new WeakMap(), y = new WeakMap(), K = new WeakMap(), Ct = new WeakSet(), Le = function(e, n, i) {
  ...
  n.length && n.on(F.START, d(this, Nt, Te).bind(this)), e.find(".type > button").on("click", async (u) => {
    ...
    if (u.stopPropagation(), p.parent().hasClass("open"))
      ...
      this.context = new Tn(this, p.closest(".node"), l), this.context.selectItem = (g, k, v) => d(this, vt, Ae).call(this, g, k, v);
    }
  ...
  a.length && a.on("click", (u) => {
    ...
    p.data("value", l).find("i").text(l.toString().toUpperCase()), d(this, A, x).call(this);
  });
}, Q = new WeakSet(), ft = function() {
  P(this, K, !0);
}, tt = new WeakSet(), ht = function() {
  f(this, K) && (d(this, A, x).call(this), P(this, K, !1));
  ...
  f(this, y).$nodes.on(F.MOVE, d(this, Et, xe).bind(this)), c(window).on(F.END, d(this, kt, Oe).bind(this));
