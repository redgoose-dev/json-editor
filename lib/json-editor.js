...
function Vt(t, e) {
  const n = Je(e);
  return !t || !n && !U(e) && !v(e) ? [] : !n && je.test(t) ? e.getElementsByClassName(t.slice(1).replace(/\\/g, "")) : !n && Ye.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
}
class Tt {
  constructor(e, n) {
    if (!e)
    ...
    if (k(e)) {
      const s = n || O;
      if (i = Ue.test(e) && U(s) ? s.getElementById(e.slice(1).replace(/\\/g, "")) : Ve.test(e) ? de(e) : Mt(s) ? s.find(e) : k(s) ? o(s).find(e) : Vt(e, s), !i)
        return;
    } else if (V(e))
      return this.ready(e);
...
function Ke(t) {
  return R(t) ? this.get().map((e) => v(e) || Fe(e) ? e.textContent : "").join("") : this.each((e, n) => {
    v(n) && (n.textContent = t);
  });
}
a.text = Ke;
...
function Ot(t) {
  return k(t) ? (e, n) => he(n, t) : V(t) ? t : Mt(t) ? (e, n) => t.is(n) : t ? (e, n) => n === t : () => !1;
}
a.filter = function(t) {
  const e = Ot(t);
...
function sn(t, e) {
  ...
  n.filter("script").add(n.find("script")).each((i, s) => {
    if (en.test(s.type) && re.contains(s)) {
      const r = j("script");
      r.text = s.textContent.replace(tn, ""), E(nn, (u, c) => {
        s[c] && (r[c] = s[c]);
...
function yn(t, e) {
  ...
  if (k(t))
    return arguments.length < 2 ? this[0] && te(this[0], t) : R(e) ? this : this.each((n, i) => {
      gn(i, t, e);
    });
  for (const n in t)
    this.data(n, t[n]);
...
a.toggle = function(t) {
  return this.each((e, n) => {
    if (!v(n))
      return;
    const i = Xt(n);
    (R(t) ? i : t) ? (n.style.display = n[ee] || "", Xt(n) && (n.style.display = qe(n.tagName))) : i || (n[ee] = S(n, "display"), n.style.display = "none");
  });
};
a.hide = function() {
...
a.off = function(t, e, n) {
  if (R(t))
    ...
    V(e) && (n = e, e = ""), E(xt(t), (i, s) => {
      const [r, u] = Kt(s), c = Gt(r);
      this.each((d, f) => {
        !v(f) && !U(f) && !et(f) || mt(f, c, u, e, n);
      });
    });
  else
    for (const i in t)
...
function Cn(t, e, n, i, s) {
  ...
  return k(e) || (R(e) || ot(e) ? e = "" : R(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (E(xt(t), (r, u) => {
    const [c, d] = Kt(u), f = Gt(c), p = c in Ce, w = c in Wt;
    f && this.each((L, b) => {
      if (!v(b) && !U(b) && !et(b))
        return;
      const B = function(m) {
        ...
        if (m.namespace && !ve(d, m.namespace.split(Zt)) || !e && (w && (m.target !== b || m.___ot === f) || p && m.relatedTarget && b.contains(m.relatedTarget)))
          return;
        let Y = b;
        if (e) {
          let J = m.target;
        ...
        s && mt(b, f, d, e, B), Be === !1 && (m.preventDefault(), m.stopPropagation());
      };
      B.guid = i.guid = i.guid || o.guid++, bn(b, f, d, e, B);
    });
  }), this) : this;
}
a.on = Cn;
...
G = new WeakMap(), K = new WeakMap(), bt = new WeakSet(), ke = function(e, n, i = !1) {
  function s(c, d) {
    let f = "";
    const { key: p, label: w, children: L } = c;
    if (i)
      switch (p) {
        case l.STRING:
        case l.NUMBER:
    ...
    return f += `<li${b}>`, f += `<button type="button"${m}>`, f += B, f += `<em class="label">${w}</em>`, (p === "change-type" || p === "insert") && (f += `<span class="arrow">${Rn}</span>`), f += "</button>", (L == null ? void 0 : L.length) > 0 && (f += '<div class="children">', f += r(L, p), f += "</div>"), f += "</li>", f;
  }
...
var y, q, vt, Le, ct, Dt, z, ft, Et, Te, Nt, xe, X, ht, P, it, at, Pt, N, A, ut, Ht, H, st, lt, It, I, rt, Q, dt, tt, pt, kt, Oe, At, Se, Rt, _e;
class $n {
  constructor(e, n = {}) {
    C(this, vt);
    C(this, ct);
  ...
  addNode(e, n, i = {}, s = !0, r = !0) {
    ...
    e = o(e);
    const d = n.type === void 0 ? ie(n.value) : n.type, f = h(this, z, ft).call(this, d, !1);
    h(this, X, ht).call(this, f, {
      ...n,
      open: u,
      type: d,
      depth: e.data("depth") + 1
    }), h(this, I, rt).call(this, f), e.find("& > .node__children > ul").append(f), r && h(this, H, st).call(this, e), (d === l.ARRAY || d === l.OBJECT) && c && typeof c == "function" && c(f.get(0), n.value), s && h(this, N, A).call(this);
  }
  /**
   * remove node
  ...
  removeNode(e, n = !0) {
    ...
    e.remove(), h(this, H, st).call(this, i), n && h(this, N, A).call(this);
  }
  /**
   * change type
   * @param {HTMLElement} node
  ...
  changeType(e, n, i = !0) {
    ...
    s.empty(), s.html(h(this, z, ft).call(this, n, c).html()), u && s.find("& > .node__children > .tree").html(u), h(this, X, ht).call(this, s, r), h(this, I, rt).call(this, s), s.attr("data-type", n), i && h(this, N, A).call(this);
  }
  changeKey(e, n) {
    o(e).find(".key > div").text(n), h(this, N, A).call(this);
  }
  changeValue(e, n) {
    o(e).find(".value > div").text(n), h(this, N, A).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, n = !0) {
    ...
    h(this, I, rt).call(this, i), e.after(i), h(this, H, st).call(this, e.parent().closest(".node")), n && h(this, N, A).call(this);
  }
  /**
   * fold node
   * @param {HTMLElement} $node
  ...
  clear() {
    this.el.tree && (this.el.body.empty(), this.replace({}, !1), h(this, N, A).call(this));
  }
  destroy() {
  ...
  replace(e, n = !0) {
    ...
    this.import(i, e, !1, !1), n && h(this, N, A).call(this);
  }
  /**
   * import data
   * @param {HTMLElement} $target
  ...
  import(e, n, i = !0, s = !0) {
    ...
    }), s && h(this, H, st).call(this, e), i && h(this, N, A).call(this);
  }
  /**
   * export
   * @param {HTMLElement} $node
...
y = new WeakMap(), q = new WeakMap(), vt = new WeakSet(), Le = function(e, n, i) {
  ...
  return i += '<div class="node__body">', n || (i += `<div class="sort">${Tn}</div>`), i += '<div class="type"><button type="button"></button></div>', (e === l.OBJECT || e === l.ARRAY) && (i += `<button type="button" class="fold">${Ln}</button>`), n || (i += '<div class="key"></div>'), i += '<em class="count"></em>', n || (i += '<div class="value"></div>'), i += "</div>", i += '<div class="node__children"><ul class="tree"/></div>', i += "</li>", o(i);
  ...
  const { key: i, value: s, type: r, open: u, depth: c } = n, d = e.hasClass("root"), f = e.children(".node__body");
  if (f.find(".type > button").html(`<i class="type-icon type-icon--${r}">${Ne[r]}</i>`), (r === l.OBJECT || r === l.ARRAY) && this.fold(e, u), c !== void 0 && e.attr("data-depth", c), !d) {
  ...
  const n = (r, u) => {
    ...
    return r.find("& > .node__children > ul > li").each((f, p) => {
      if (!(u === l.ARRAY || u === l.OBJECT))
        return !0;
      p = o(p);
      const w = h(this, P, it).call(this, p);
      switch (w) {
        case l.OBJECT:
        case l.ARRAY:
          switch (u) {
  ...
  if ([l.OBJECT, l.ARRAY].includes(s))
    return n(i, s);
  ...
  n.length && n.on(Z.START, h(this, kt, Oe).bind(this)), e.find(".type > button").on("click", async (c) => {
    ...
    if (d.parent().hasClass("open"))
      ...
      this.context = new On(this, d.closest(".node"), f), this.context.selectItem = (p, w, L) => h(this, Nt, xe).call(this, p, w, L);
    }
  ...
  u.length && u.on("click", (c) => {
    ...
    d.data("value", f).find("i").text(f.toString().toUpperCase()), h(this, N, A).call(this);
  });
}, Q = new WeakSet(), dt = function() {
  $(this, q, !0);
}, tt = new WeakSet(), pt = function() {
  g(this, q) && (h(this, N, A).call(this), $(this, q, !1));
