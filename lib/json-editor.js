...
var et = (t, e, n) => (Be(t, typeof e != "symbol" ? e + "" : e, n), n), Ot = (t, e, n) => {
  if (!e.has(t))
...
const O = document, pt = window, ie = O.documentElement, j = O.createElement.bind(O), se = j("div"), St = j("table"), $e = j("tbody"), Gt = j("tr"), { isArray: Lt, prototype: re } = Array, { concat: Me, filter: Ht, indexOf: oe, map: ce, push: Pe, slice: ae, some: It, splice: De } = re, He = /^#(?:[\w-]|\\.|[^\x00-\xa0])*$/, Ie = /^\.(?:[\w-]|\\.|[^\x00-\xa0])*$/, Ue = /<.+>/, je = /^\w+$/;
function Ut(t, e) {
  const n = Ve(e);
  return !t || !n && !U(e) && !v(e) ? [] : !n && Ie.test(t) ? e.getElementsByClassName(t.slice(1).replace(/\\/g, "")) : !n && je.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
}
class At {
  constructor(e, n) {
    if (!e)
    ...
    if (k(e)) {
      const s = n || O;
      if (i = He.test(e) && U(s) ? s.getElementById(e.slice(1).replace(/\\/g, "")) : Ue.test(e) ? fe(e) : $t(s) ? s.find(e) : k(s) ? o(s).find(e) : Ut(e, s), !i)
        return;
    } else if (V(e))
      return this.ready(e);
...
c.hasClass = function(t) {
  return !!t && It.call(this, (e) => v(e) && e.classList.contains(t));
};
c.get = function(t) {
  return L(t) ? ae.call(this) : (t = Number(t), this[t < 0 ? t + this.length : t]);
};
c.eq = function(t) {
  return o(this.get(t));
};
...
function We(t) {
  return L(t) ? this.get().map((e) => v(e) || Ye(e) ? e.textContent : "").join("") : this.each((e, n) => {
    v(n) && (n.textContent = t);
  });
}
c.text = We;
...
function xt(t) {
  return k(t) ? (e, n) => le(n, t) : V(t) ? t : $t(t) ? (e, n) => t.is(n) : t ? (e, n) => n === t : () => !1;
}
c.filter = function(t) {
  const e = xt(t);
...
o.parseHTML = fe;
c.has = function(t) {
  const e = k(t) ? (n, i) => Ut(t, i).length : (n, i) => i.contains(t);
...
function ze(t) {
  return arguments.length ? this.each((e, n) => {
    ...
    if (i || we.test(n.type)) {
      const s = Lt(t) ? ce.call(t, String) : ot(t) ? [] : [String(t)];
      i ? N(n.options, (r, u) => {
...
function en(t, e) {
  ...
  n.filter("script").add(n.find("script")).each((i, s) => {
    if (Qe.test(s.type) && ie.contains(s)) {
      const r = j("script");
      r.text = s.textContent.replace(Xe, ""), N(tn, (u, a) => {
        s[a] && (r[a] = s[a]);
...
function pn(t, e) {
  ...
  if (k(t))
    return arguments.length < 2 ? this[0] && Xt(this[0], t) : L(e) ? this : this.each((n, i) => {
      dn(i, t, e);
    });
  for (const n in t)
    this.data(n, t[n]);
...
N([!0, !1], (t, e) => {
  N(["Width", "Height"], (n, i) => {
    ...
    c[s] = function(r) {
      if (this[0])
        return tt(this[0]) ? e ? this[0][`inner${i}`] : this[0].document.documentElement[`client${i}`] : U(this[0]) ? ye(this[0], i) : this[0][`${e ? "offset" : "client"}${i}`] + (r && e ? T(this[0], `margin${n ? "Top" : "Left"}`) + T(this[0], `margin${n ? "Bottom" : "Right"}`) : 0);
    };
  });
});
N(["Width", "Height"], (t, e) => {
  ...
  c[n] = function(i) {
    ...
    if (!arguments.length)
      return tt(this[0]) ? this[0].document.documentElement[`client${e}`] : U(this[0]) ? ye(this[0], e) : this[0].getBoundingClientRect()[n] - Kt(this[0], !t);
...
c.toggle = function(t) {
  return this.each((e, n) => {
    if (!v(n))
      return;
    const i = qt(n);
    (L(t) ? i : t) ? (n.style.display = n[Qt] || "", qt(n) && (n.style.display = Ge(n.tagName))) : i || (n[Qt] = S(n, "display"), n.style.display = "none");
  });
};
c.hide = function() {
...
c.off = function(t, e, n) {
  if (L(t))
    ...
    V(e) && (n = e, e = ""), N(Tt(t), (i, s) => {
      const [r, u] = Wt(s), a = Zt(r);
      this.each((d, f) => {
        !v(f) && !U(f) && !tt(f) || yt(f, a, u, e, n);
      });
    });
  else
    for (const i in t)
...
function mn(t, e, n, i, s) {
  ...
  return k(e) || (L(e) || ot(e) ? e = "" : L(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (N(Tt(t), (r, u) => {
    const [a, d] = Wt(u), f = Zt(a), p = a in me, E = a in Ft;
    f && this.each((w, m) => {
      if (!v(m) && !U(m) && !tt(m))
        return;
      const B = function(b) {
        ...
        if (b.namespace && !Ce(d, b.namespace.split(Jt)) || !e && (E && (b.target !== m || b.___ot === f) || p && b.relatedTarget && m.contains(b.relatedTarget)))
          return;
        let Y = m;
        if (e) {
          let J = b.target;
      ...
      B.guid = i.guid = i.guid || o.guid++, yn(m, f, d, e, B);
    });
  }), this) : this;
}
c.on = mn;
...
class Tn {
  constructor(e, n, i = !1) {
    ...
    C(this, G, void 0);
    $(this, W, e), this.el.node = o(n), $(this, G, String(this.el.node.data("type"))), this.el.type = this.el.node.find("& > .node__body > .type"), this.el.type.addClass("open"), this.el.dialog = h(this, mt, Ne).call(this, An, g(this, G), i), this.el.dialog.on("click", (s) => s.stopPropagation()), this.el.dialog.find("button").on("click", (s) => h(this, bt, Ee).call(this, s)), g(this, W).customContext(this.el.dialog.get(0), {
      node: this.el.node.get(0),
      type: g(this, G),
      isRoot: i
    }, o), this.el.type.append(this.el.dialog), o(window).on(Z.CLICK, (s) => this.close(s)), o(window).on(Z.KEYUP, (s) => h(this, Ct, ke).call(this, s));
  }
  close() {
    this.el.type.removeClass("open"), this.el.dialog.remove(), o(window).off(Z.CLICK), o(window).off(Z.KEYUP), delete g(this, W).context;
  }
}
W = new WeakMap(), G = new WeakMap(), mt = new WeakSet(), Ne = function(e, n, i = !1) {
  function s(a, d) {
    let f = "";
    const { key: p, label: E, children: w } = a;
    if (i)
      switch (p) {
        case l.STRING:
        case l.NUMBER:
    ...
    switch (p) {
      ...
      case l.BOOLEAN:
      case l.NULL:
        m = ' class="type"', B = `<i class="type-icon type-icon--${p}">${ve[p]}</i>`, b = ` data-mode="${d}" data-type="${p}"`, d === "change-type" && p === n && (b = " disabled");
        break;
    }
    return f += `<li${m}>`, f += `<button type="button"${b}>`, f += B, f += `<em class="label">${E}</em>`, (p === "change-type" || p === "insert") && (f += `<span class="arrow">${kn}</span>`), f += "</button>", (w == null ? void 0 : w.length) > 0 && (f += '<div class="children">', f += r(w, p), f += "</div>"), f += "</li>", f;
  }
...
var y, K, wt, Re, ct, Mt, q, lt, vt, Le, Nt, Ae, z, ft, D, it, at, Pt, R, A, ut, Dt, H, st, I, rt, X, ht, Q, dt, Et, Te, kt, xe, Rt, Oe;
class _n {
  constructor(e, n = {}) {
    C(this, wt);
    C(this, ct);
  ...
  addNode(e, n, i = !0, s = !0) {
    n = { ...En, ...n };
    const { data: r, between: u, open: a, callback: d } = n;
    e = o(e);
    const { key: f, value: p, type: E } = r, w = h(this, q, lt).call(this, E, !1);
    h(this, z, ft).call(this, w, { ...r, open: a }), h(this, I, rt).call(this, w);
    const m = e.find("& > .node__children > ul");
    u === "before" ? m.prepend(w) : m.append(w), s && h(this, H, st).call(this, e), (E === l.ARRAY || E === l.OBJECT) && d && typeof d == "function" && d(w.get(0), p), i && h(this, R, A).call(this);
  }
  /**
   * remove node
  ...
  removeNode(e, n = !0) {
    ...
    e.remove(), h(this, H, st).call(this, i), n && h(this, R, A).call(this);
  }
  /**
   * change type
   * @param {HTMLElement} node
  ...
  changeType(e, n, i = !0) {
    ...
    s.empty(), s.html(h(this, q, lt).call(this, n, a).html()), u && s.find("& > .node__children > .tree").html(u), h(this, z, ft).call(this, s, r), h(this, I, rt).call(this, s), s.attr("data-type", n), i && h(this, R, A).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, n = !0) {
    ...
    h(this, I, rt).call(this, i), e.after(i), h(this, H, st).call(this, e.parent().closest(".node")), n && h(this, R, A).call(this);
  }
  /**
   * fold node
   * @param {HTMLElement} $node
  ...
  replace(e, n = !0) {
    ...
    const i = h(this, vt, Le).call(this, e);
  ...
  import(e, n, i = !0, s = !0) {
    e = o(e), o.each(n, (r, u) => {
      const a = ee(u), d = { key: r, value: u, type: a };
      this.addNode(e, {
        data: d,
        open: !1,
        callback: (f, p) => this.import(f, p, !1, !1)
      }, !1, !1);
    }), s && h(this, H, st).call(this, e), i && h(this, R, A).call(this);
  }
  /**
   * export
   * @param {HTMLElement} $node
...
y = new WeakMap(), K = new WeakMap(), wt = new WeakSet(), Re = function(e, n, i) {
  switch (e[n] = i, n) {
    case "theme":
  ...
  return i += '<div class="node__body">', n || (i += `<div class="sort">${Ln}</div>`), i += '<div class="type"><button type="button"></button></div>', (e === l.OBJECT || e === l.ARRAY) && (i += `<button type="button" class="fold">${Rn}</button>`), n || (i += '<div class="key"></div>'), i += '<em class="count"></em>', n || (i += '<div class="value"></div>'), i += "</div>", i += '<div class="node__children"><ul class="tree"/></div>', i += "</li>", o(i);
}, vt = new WeakSet(), Le = function(e) {
  const n = ee(e), i = h(this, q, lt).call(this, n, !0);
...
}, Nt = new WeakSet(), Ae = function(e, n, i) {
  switch (n) {
    case "change-type":
      this.changeType(e, i);
      break;
  ...
  if (d.find(".type > button").html(`<i class="type-icon type-icon--${r}">${ve[r]}</i>`), (r === l.OBJECT || r === l.ARRAY) && this.fold(e, u), !a) {
  ...
  this.options.live && this.preview && typeof this.preview == "function" && this.preview(h(this, ut, Dt).call(this));
  ...
  const n = (r, u) => {
    ...
    return r.find("& > .node__children > ul > li").each((f, p) => {
      if (!(u === l.ARRAY || u === l.OBJECT))
        return !0;
      p = o(p);
      const E = h(this, D, it).call(this, p);
      switch (E) {
        case l.OBJECT:
        case l.ARRAY:
          switch (u) {
  ...
  const n = e.find(".sort");
  n.length && n.on(F.START, h(this, Et, Te).bind(this)), e.find(".type > button").on("click", async (a) => {
    ...
    if (a.stopPropagation(), d.parent().hasClass("open"))
      ...
      this.context = new Tn(this, d.closest(".node"), f), this.context.selectItem = (p, E, w) => h(this, Nt, Ae).call(this, p, E, w);
    }
  ...
  }).on("input", (a) => h(this, X, ht).call(this, a)).on("blur", (a) => h(this, Q, dt).call(this, a));
  ...
  r.length && r.on("input", (a) => h(this, X, ht).call(this, a)).on("blur", (a) => h(this, Q, dt).call(this, a));
  const u = e.find(".value > .type-boolean");
  u.length && u.on("click", (a) => {
    const d = o(a.currentTarget), f = !d.data("value");
  ...
  if (e.pointerType !== "touch") {
    ...
    g(this, y).$nodes.on(F.MOVE, h(this, kt, xe).bind(this)), o(window).on(F.END, h(this, Rt, Oe).bind(this));
  }
}, kt = new WeakSet(), xe = function(e) {
  const n = o(e.currentTarget), i = n.children(".node__body");
  if (!(i.length > 0))
    return;
