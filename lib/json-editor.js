...
c.get = function(t) {
  return A(t) ? ae.call(this) : (t = Number(t), this[t < 0 ? t + this.length : t]);
};
c.eq = function(t) {
  return o(this.get(t));
};
...
function We(t) {
  return A(t) ? this.get().map((e) => v(e) || Ye(e) ? e.textContent : "").join("") : this.each((e, n) => {
    v(n) && (n.textContent = t);
  });
}
c.text = We;
...
function pn(t, e) {
  ...
  if (k(t))
    return arguments.length < 2 ? this[0] && Xt(this[0], t) : A(e) ? this : this.each((n, i) => {
      dn(i, t, e);
    });
  for (const n in t)
    this.data(n, t[n]);
...
c.toggle = function(t) {
  return this.each((e, n) => {
    if (!v(n))
      return;
    const i = qt(n);
    (A(t) ? i : t) ? (n.style.display = n[Qt] || "", qt(n) && (n.style.display = Ge(n.tagName))) : i || (n[Qt] = S(n, "display"), n.style.display = "none");
  });
};
c.hide = function() {
...
function mn(t, e, n, i, s) {
  ...
  return k(e) || (A(e) || ot(e) ? e = "" : A(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (N(Tt(t), (r, u) => {
...
var y, K, wt, Re, ct, Mt, q, lt, vt, Ae, Nt, Le, z, ft, D, it, at, Pt, R, L, ut, Dt, H, st, I, rt, X, ht, Q, dt, Et, Te, kt, xe, Rt, Oe;
class _n {
  constructor(e, n = {}) {
    C(this, wt);
    C(this, ct);
  ...
  addNode(e, n, i = !0, s = !0) {
    ...
    u === "before" ? m.prepend(w) : m.append(w), s && h(this, H, st).call(this, e), (E === l.ARRAY || E === l.OBJECT) && d && typeof d == "function" && d(w.get(0), p), i && h(this, R, L).call(this);
  }
  /**
   * remove node
  ...
  removeNode(e, n = !0) {
    ...
    e.remove(), h(this, H, st).call(this, i), n && h(this, R, L).call(this);
  }
  /**
   * change type
   * @param {HTMLElement} node
  ...
  changeType(e, n, i = !0) {
    ...
    s.empty(), s.html(h(this, q, lt).call(this, n, a).html()), u && s.find("& > .node__children > .tree").html(u), h(this, z, ft).call(this, s, r), h(this, I, rt).call(this, s), s.attr("data-type", n), i && h(this, R, L).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, n = !0) {
    ...
    h(this, I, rt).call(this, i), e.after(i), h(this, H, st).call(this, e.parent().closest(".node")), n && h(this, R, L).call(this);
  }
  /**
   * fold node
   * @param {HTMLElement} $node
  ...
  clear() {
    this.el.tree && (this.el.body.empty(), this.replace({}, !1), h(this, R, L).call(this));
  }
  destroy() {
  ...
  replace(e, n = !0) {
    ...
    this.import(i, e, !1, !1), n && h(this, R, L).call(this);
  }
  /**
   * import data
   * @param {HTMLElement} $target
  ...
  import(e, n, i = !0, s = !0) {
    ...
    }), s && h(this, H, st).call(this, e), i && h(this, R, L).call(this);
  }
  /**
   * export
   * @param {HTMLElement} $node
...
y = new WeakMap(), K = new WeakMap(), wt = new WeakSet(), Re = function(e, n, i) {
  ...
  return i += '<div class="node__body">', n || (i += `<div class="sort">${An}</div>`), i += '<div class="type"><button type="button"></button></div>', (e === l.OBJECT || e === l.ARRAY) && (i += `<button type="button" class="fold">${Rn}</button>`), n || (i += '<div class="key"></div>'), i += '<em class="count"></em>', n || (i += '<div class="value"></div>'), i += "</div>", i += '<div class="node__children"><ul class="tree"/></div>', i += "</li>", o(i);
  ...
  n.length && n.on(F.START, h(this, Et, Te).bind(this)), e.find(".type > button").on("click", async (a) => {
    ...
    if (a.stopPropagation(), d.parent().hasClass("open"))
      ...
      this.context = new Tn(this, d.closest(".node"), f), this.context.selectItem = (p, E, w) => h(this, Nt, Le).call(this, p, E, w);
    }
  ...
  u.length && u.on("click", (a) => {
    ...
    d.data("value", f).find("i").text(f.toString().toUpperCase()), h(this, R, L).call(this);
  });
}, X = new WeakSet(), ht = function() {
  $(this, K, !0);
}, Q = new WeakSet(), dt = function() {
  g(this, K) && (h(this, R, L).call(this), $(this, K, !1));
  ...
  if (e.pointerType === "touch") {
    const { clientX: a, clientY: d } = e, f = document.elementFromPoint(a, d).closest(".node");
