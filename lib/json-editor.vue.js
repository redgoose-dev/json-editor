...
var $e = (t, e, n) => e in t ? Se(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
var Tt = (t, e, n) => ($e(t, typeof e != "symbol" ? e + "" : e, n), n), Ot = (t, e, n) => {
  if (!e.has(t))
...
import { ref as Be, onMounted as Me, onUnmounted as Pe, openBlock as Ue, createElementBlock as De } from "vue";
const S = document, dt = window, ie = S.documentElement, j = S.createElement.bind(S), se = j("div"), _t = j("table"), He = j("tbody"), Gt = j("tr"), { isArray: Rt, prototype: re } = Array, { concat: Ie, filter: Dt, indexOf: oe, map: ce, push: je, slice: ae, some: Ht, splice: Ve } = re, Ye = /^#(?:[\w-]|\\.|[^\x00-\xa0])*$/, Je = /^\.(?:[\w-]|\\.|[^\x00-\xa0])*$/, Fe = /<.+>/, Ze = /^\w+$/;
function It(t, e) {
  const n = We(e);
  return !t || !n && !I(e) && !N(e) ? [] : !n && Je.test(t) ? e.getElementsByClassName(t.slice(1).replace(/\\/g, "")) : !n && Ze.test(t) ? e.getElementsByTagName(t) : e.querySelectorAll(t);
}
class Lt {
  constructor(e, n) {
    if (!e)
    ...
    if (L(e)) {
      const s = n || S;
      if (i = Ye.test(e) && I(s) ? s.getElementById(e.slice(1).replace(/\\/g, "")) : Fe.test(e) ? fe(e) : Bt(s) ? s.find(e) : L(s) ? c(s).find(e) : It(e, s), !i)
        return;
    } else if (V(e))
      return this.ready(e);
...
function pt(...t) {
  const e = Ke(t[0]) ? t.shift() : !1, n = t.shift(), i = t.length;
  if (!n)
    return {};
  if (!i)
    return pt(e, c, n);
...
o.hasClass = function(t) {
  return !!t && Ht.call(this, (e) => N(e) && e.classList.contains(t));
};
o.get = function(t) {
...
function Xe(t) {
  return x(t) ? this.get().map((e) => N(e) || Ge(e) ? e.textContent : "").join("") : this.each((e, n) => {
    N(n) && (n.textContent = t);
  });
}
o.text = Xe;
...
o.filter = function(t) {
  const e = xt(t);
  return c(Dt.call(this, (n, i) => e.call(n, i, n)));
};
function U(t, e) {
  return e ? t.filter(e) : t;
}
o.detach = function(t) {
  return U(this, t).each((e, n) => {
    n.parentNode && n.parentNode.removeChild(n);
  }), this;
};
const tn = /^\s*<(\w+)[^>]*>/, en = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, zt = {
  "*": se,
  tr: He,
  td: Gt,
  th: Gt,
...
function fe(t) {
  ...
  if (en.test(t))
    return [j(RegExp.$1)];
  const e = tn.test(t) && RegExp.$1, n = zt[e] || zt["*"];
  return n.innerHTML = t, c(n.childNodes).detach().get();
}
c.parseHTML = fe;
o.has = function(t) {
  const e = L(t) ? (n, i) => It(t, i).length : (n, i) => i.contains(t);
...
function he(t) {
  return t.multiple && t.options ? B(Dt.call(t.options, (e) => e.selected && !e.disabled && !e.parentNode.disabled), "value") : t.value || "";
}
function nn(t) {
...
o.is = function(t) {
  const e = xt(t);
  return Ht.call(this, (n, i) => e.call(n, i, n));
};
c.guid = 1;
function _(t) {
  return t.length > 1 ? Dt.call(t, (e, n, i) => oe.call(i, e) === n) : t;
}
c.unique = _;
o.add = function(t, e) {
...
o.children = function(t) {
  return U(c(_(B(this, (e) => e.children))), t);
};
o.parent = function(t) {
  return U(c(_(B(this, "parentNode"))), t);
};
o.index = function(t) {
...
o.siblings = function(t) {
  return U(c(_(B(this, (e) => c(e).parent().children().not(e)))), t);
};
o.find = function(t) {
  return c(_(B(this, (e) => It(t, e))));
};
const sn = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, rn = /^$|^module$|\/(java|ecma)script/i, on = ["type", "src", "nonce", "noModule"];
function cn(t, e) {
  const n = c(t);
  n.filter("script").add(n.find("script")).each((i, s) => {
    if (rn.test(s.type) && ie.contains(s)) {
      const r = j("script");
      r.text = s.textContent.replace(sn, ""), k(on, (u, a) => {
        s[a] && (r[a] = s[a]);
...
function an(t, e, n, i, s) {
  i ? t.insertBefore(e, n ? t.firstChild : null) : t.nodeName === "HTML" ? t.parentNode.replaceChild(e, t) : t.parentNode.insertBefore(e, n ? t : t.nextSibling), s && cn(e, t.ownerDocument);
}
function D(t, e, n, i, s, r, u, a) {
  return k(t, (g, h) => {
    k(c(h), (p, v) => {
      k(c(e), (R, b) => {
        const M = n ? v : b, m = n ? b : v, Y = n ? p : R;
        an(M, Y ? m.cloneNode(!0) : m, i, s, !Y);
      }, a);
    }, u);
  }, r), e;
}
...
o.contents = function() {
  return c(_(B(this, (t) => t.tagName === "IFRAME" ? [t.contentDocument] : t.tagName === "TEMPLATE" ? t.content.childNodes : t.childNodes)));
};
o.next = function(t, e, n) {
  return U(c(_(B(this, "nextElementSibling", e, n))), t);
};
...
o.parents = function(t, e) {
  return U(c(_(B(this, "parentElement", !0, e))), t);
};
o.parentsUntil = function(t, e) {
  return this.parents(e, t);
};
o.prev = function(t, e, n) {
  return U(c(_(B(this, "previousElementSibling", e, n))), t);
};
...
o.map = function(t) {
  return c(Ie.apply([], ce.call(this, (e, n) => t.call(e, n, e))));
};
o.clone = function() {
...
const $t = {}, { style: hn } = se, dn = ["webkit", "moz", "ms"];
function pn(t, e = Yt(t)) {
  if (e)
    return t;
  if (!$t[t]) {
    const n = Vt(t), i = `${n[0].toUpperCase()}${n.slice(1)}`, s = `${n} ${dn.join(`${i} `)}${i}`.split(" ");
    k(s, (r, u) => {
      if (u in hn)
        return $t[t] = u, !1;
    });
...
function pe(t, e, n = Yt(t)) {
  return !n && !gn[t] && ue(e) ? `${e}px` : e;
}
function yn(t, e) {
  if (L(t)) {
    const n = Yt(t);
    return t = pn(t, n), arguments.length < 2 ? this[0] && $(this[0], t, n) : t ? (e = pe(t, e, n), this.each((i, s) => {
...
function Xt(t, e) {
  ...
  return mn.test(n) ? n : ge(JSON.parse, n);
}
function bn(t, e, n) {
...
k([!0, !1], (t, e) => {
  k(["Width", "Height"], (n, i) => {
    ...
    o[s] = function(r) {
      if (this[0])
        return et(this[0]) ? e ? this[0][`inner${i}`] : this[0].document.documentElement[`client${i}`] : I(this[0]) ? ye(this[0], i) : this[0][`${e ? "offset" : "client"}${i}`] + (r && e ? O(this[0], `margin${n ? "Top" : "Left"}`) + O(this[0], `margin${n ? "Bottom" : "Right"}`) : 0);
    };
  });
});
k(["Width", "Height"], (t, e) => {
  ...
  o[n] = function(i) {
    ...
    if (!arguments.length)
      return et(this[0]) ? this[0].document.documentElement[`client${e}`] : I(this[0]) ? ye(this[0], e) : this[0].getBoundingClientRect()[n] - Kt(this[0], !t);
...
o.toggle = function(t) {
  return this.each((e, n) => {
    if (!N(n))
      return;
    const i = qt(n);
    (x(t) ? i : t) ? (n.style.display = n[Qt] || "", qt(n) && (n.style.display = Qe(n.tagName))) : i || (n[Qt] = $(n, "display"), n.style.display = "none");
  });
};
o.hide = function() {
...
const te = "___ce", Jt = ".", Ft = { focus: "focusin", blur: "focusout" }, me = { mouseenter: "mouseover", mouseleave: "mouseout" }, wn = /^(mouse|pointer|contextmenu|drag|drop|click|dblclick)/i;
function Zt(t) {
  return me[t] || Ft[t] || t;
}
function Wt(t) {
...
o.trigger = function(t, e) {
  if (L(t)) {
    ...
    t = S.createEvent(u), t.initEvent(r, !0, !0), t.namespace = s.join(Jt), t.___ot = i;
  }
  t.___td = e;
...
function Ce(t, e) {
  return !e || !Ht.call(e, (n) => t.indexOf(n) < 0);
}
...
o.remove = function(t) {
  return U(this, t).detach().off(), this;
};
...
function En(t, e, n, i, s) {
  ...
  return L(e) || (x(e) || st(e) ? e = "" : x(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (k(At(t), (r, u) => {
    ...
    h && this.each((R, b) => {
      ...
      const M = function(m) {
        ...
        const _e = i.call(Y, m, m.___td);
        s && gt(b, h, g, e, M), _e === !1 && (m.preventDefault(), m.stopPropagation());
      };
      M.guid = i.guid = i.guid || c.guid++, vn(b, h, g, e, M);
    });
  }), this) : this;
}
o.on = En;
...
const kn = /\r?\n/g;
function Rn(t, e) {
  return `&${encodeURIComponent(t)}=${encodeURIComponent(e.replace(kn, `\r
`))}`;
}
...
class $n {
  constructor(e, n, i = !1) {
    ...
    C(this, G, void 0);
    P(this, W, e), l(this, E).node = c(n), P(this, G, String(l(this, E).node.data("type"))), l(this, E).type = l(this, E).node.find("& > .node__body > .type"), l(this, E).type.addClass("open"), l(this, E).dialog = d(this, yt, Ee).call(this, Sn, l(this, G), i), l(this, E).dialog.on("click", (s) => s.stopPropagation()), l(this, E).dialog.find("button").on("click", (s) => d(this, mt, Ne).call(this, s)), l(this, W).customContext(l(this, E).dialog.get(0), {
...
W = new WeakMap(), E = new WeakMap(), G = new WeakMap(), yt = new WeakSet(), Ee = function(e, n, i = !1) {
  function s(a, g) {
    ...
    return h += `<li${b}>`, h += `<button type="button"${m}>`, h += M, h += `<em class="label">${v}</em>`, (p === "change-type" || p === "insert") && (h += `<span class="arrow">${Tn}</span>`), h += "</button>", (R == null ? void 0 : R.length) > 0 && (h += '<div class="children">', h += r(R, p), h += "</div>"), h += "</li>", h;
  }
...
var w, y, K, Ct, Re, rt, Mt, q, at, wt, Le, vt, Ae, z, ut, X, lt, ot, Pt, A, T, ct, Ut, H, it, Q, ft, tt, ht, Et, xe, Nt, Te, kt, Oe;
class Pn {
  constructor(e, n = {}) {
    C(this, Ct);
    C(this, rt);
    ...
    C(this, y, void 0);
    C(this, K, !1);
    l(this, w).wrap = c(e), l(this, w).body = c('<div class="json-editor"></div>'), this.options = new Proxy(Object.assign({}, An, n), {
      get: (i, s) => i[s],
  ...
  addNode(e, n, i = !0) {
    ...
    d(this, z, ut).call(this, v, { ...s, open: u }), d(this, H, it).call(this, v);
    const R = e.find("& > .node__children > ul");
    r === "before" ? R.prepend(v) : R.append(v), (p === f.ARRAY || p === f.OBJECT) && a && typeof a == "function" && a(v.get(0), h), i && d(this, A, T).call(this);
  }
  /**
   * remove node
  ...
  changeType(e, n, i = !0) {
    ...
    s.empty(), s.html(d(this, q, at).call(this, n, a).html()), u && s.find("& > .node__children > .tree").html(u), d(this, z, ut).call(this, s, r), d(this, H, it).call(this, s), s.attr("data-type", n), i && d(this, A, T).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  duplicate(e, n = !0) {
    ...
    d(this, H, it).call(this, i), e.after(i), n && d(this, A, T).call(this);
  }
  fold(e, n) {
    e = c(e), n === void 0 ? e.toggleClass("open") : n === !0 ? e.addClass("open") : e.removeClass("open");
  }
  clear() {
    l(this, w).tree && (l(this, w).body.empty(), this.replace({}, !1), d(this, A, T).call(this));
  }
  destroy() {
  ...
  export(e = void 0, n, i = 2) {
    let s = d(this, ct, Ut).call(this, e);
    if (n) {
      let r = 2;
...
w = new WeakMap(), y = new WeakMap(), K = new WeakMap(), Ct = new WeakSet(), Re = function(e, n, i) {
  ...
  return i += '<div class="node__body">', n || (i += `<div class="sort">${_n}</div>`), i += '<div class="type"><button type="button"></button></div>', (e === f.OBJECT || e === f.ARRAY) && (i += `<button type="button" class="fold">${On}</button>`), n || (i += '<div class="key"></div>'), i += '<em class="count"></em>', n || (i += '<div class="value"></div>'), i += "</div>", i += '<div class="node__children"><ul class="tree"/></div>', i += "</li>", c(i);
  ...
  return d(this, z, ut).call(this, i, {
    ...
    type: n,
    open: !0
  }), d(this, H, it).call(this, i), l(this, w).tree = c("<ul/>"), l(this, w).tree.append(i), l(this, w).body.append(l(this, w).tree), i;
  ...
  this.options.live && this.preview && typeof this.preview == "function" && this.preview(d(this, ct, Ut).call(this));
}, ct = new WeakSet(), Ut = function(e) {
  const n = (r, u) => {
    let a = u === f.ARRAY ? [] : {};
  ...
  const n = e.find(".sort");
  n.length && n.on(F.START, d(this, Et, xe).bind(this)), e.find(".type > button").on("click", async (a) => {
    ...
    if (a.stopPropagation(), g.parent().hasClass("open"))
      ...
      this.context = new $n(this, g.closest(".node"), h), this.context.selectItem = (p, v, R) => d(this, vt, Ae).call(this, p, v, R);
    }
  ...
  u.length && u.on("click", (a) => {
    ...
    g.data("value", h).find("i").text(h.toString().toUpperCase()), d(this, A, T).call(this);
  });
}, Q = new WeakSet(), ft = function() {
  P(this, K, !0);
}, tt = new WeakSet(), ht = function() {
  l(this, K) && (d(this, A, T).call(this), P(this, K, !1));
  ...
  l(this, y).$nodes.on(F.MOVE, d(this, Nt, Te).bind(this)), c(window).on(F.END, d(this, kt, Oe).bind(this));
