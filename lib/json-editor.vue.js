...
import { ref as Me, onMounted as He, onBeforeUnmount as Pe, watch as Gt, openBlock as Ue, createElementBlock as De } from "vue";
...
c.length = 0;
c.splice = Ye;
typeof Symbol == "function" && (c[Symbol.iterator] = oe[Symbol.iterator]);
function $t(t) {
...
function an(t, e) {
  ...
  n.filter("script").add(n.find("script")).each((i, s) => {
    if (on.test(s.type) && se.contains(s)) {
      const r = j("script");
      r.text = s.textContent.replace(rn, ""), N(cn, (u, a) => {
        s[a] && (r[a] = s[a]);
...
N(["Width", "Height"], (t, e) => {
  ...
  c[n] = function(i) {
    ...
    return this.each((r, u) => {
      if (!v(u))
        return;
      const a = _(u, "boxSizing");
      u.style[n] = ge(n, s + (a === "border-box" ? qt(u, !t) : 0));
    });
  };
});
const te = "___cd";
...
function yt(t, e, n, i, s) {
  ...
  if (e)
    r[e] && (r[e] = r[e].filter(([u, a, d]) => {
      if (s && d.guid !== s.guid || !we(u, n) || i && i !== a)
        return !0;
...
function En(t, e, n, i, s) {
  ...
  return k(e) || (L(e) || ot(e) ? e = "" : L(n) ? (n = e, e = "") : (i = n, n = e, e = "")), V(i) || (i = n, n = void 0), i ? (N(xt(t), (r, u) => {
    const [a, d] = Wt(u), f = Zt(a), p = a in be, E = a in Ft;
    f && this.each((w, m) => {
      if (!v(m) && !I(m) && !tt(m))
        return;
      const B = function(b) {
...
class $n {
  constructor(e, n, i = !1) {
    ...
    $(this, W, e), this.el.node = o(n), $(this, G, String(this.el.node.data("type"))), this.el.type = this.el.node.find("& > .node__body > .type"), this.el.type.addClass("open"), this.el.dialog = h(this, mt, Ee).call(this, Bn, g(this, G), i), this.el.dialog.on("click", (s) => s.stopPropagation()), this.el.dialog.find("button").on("click", (s) => h(this, bt, ke).call(this, s)), g(this, W).customContext(this.el.dialog.get(0), {
      ...
      type: g(this, G),
      isRoot: i
    }, o), this.el.type.append(this.el.dialog), o(window).on(Z.CLICK, (s) => this.close(s)), o(window).on(Z.KEYUP, (s) => h(this, Ct, Re).call(this, s));
  }
  close() {
...
var y, K, wt, Le, ct, Mt, q, lt, vt, Ae, Nt, xe, z, ft, P, it, at, Ht, R, A, ut, Pt, U, st, D, rt, X, ht, Q, dt, Et, Te, kt, Oe, Rt, _e;
class Pn {
  constructor(e, n = {}) {
    C(this, wt);
    C(this, ct);
  ...
  addNode(e, n, i = !0, s = !0) {
    ...
    h(this, z, ft).call(this, w, { ...r, open: a }), h(this, D, rt).call(this, w);
  ...
  changeType(e, n, i = !0) {
    const s = o(e), r = {
      ...
      value: h(this, at, Ht).call(this, s),
      type: n,
      open: s.hasClass("open")
    }, u = s.find("& > .node__children > .tree").html(), a = s.hasClass("root");
    s.empty(), s.html(h(this, q, lt).call(this, n, a).html()), u && s.find("& > .node__children > .tree").html(u), h(this, z, ft).call(this, s, r), h(this, D, rt).call(this, s), s.attr("data-type", n), i && h(this, R, A).call(this);
  }
  /**
   * duplicate
   * @param {HTMLElement} $target
  ...
  import(e, n, i = !0, s = !0) {
    e = o(e), o.each(n, (r, u) => {
      const a = ne(u), d = { key: r, value: u, type: a };
      this.addNode(e, {
        data: d,
        open: !1,
  ...
  export(e = void 0, n, i = 2) {
    let s = h(this, ut, Pt).call(this, e);
    if (n) {
      let r = 2;
...
y = new WeakMap(), K = new WeakMap(), wt = new WeakSet(), Le = function(e, n, i) {
  ...
  if (d.find(".type > button").html(`<i class="type-icon type-icon--${r}">${Ne[r]}</i>`), (r === l.OBJECT || r === l.ARRAY) && this.fold(e, u), !a) {
  ...
  this.options.live && this.preview && typeof this.preview == "function" && this.preview(h(this, ut, Pt).call(this));
}, ut = new WeakSet(), Pt = function(e) {
  const n = (r, u) => {
    let a = u === l.ARRAY ? [] : {};
    return r.find("& > .node__children > ul > li").each((f, p) => {
      if (!(u === l.ARRAY || u === l.OBJECT))
        return !0;
      p = o(p);
      const E = h(this, P, it).call(this, p);
      switch (E) {
        case l.OBJECT:
        case l.ARRAY:
          switch (u) {
        ...
        case l.BOOLEAN:
        case l.NULL:
          const w = h(this, at, Ht).call(this, p);
          switch (u) {
            case l.ARRAY:
              a.push(w);
              break;
  ...
  setup(t, { expose: e, emit: n }) {
    ...
    return He(() => {
      r = new Pn(s.value, {
        live: i.live,
        theme: i.theme
      }), r.preview = (a) => n("update", a), n("init", r);
    }), Pe(() => {
